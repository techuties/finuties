...
**New in this review (2026-08-30):** five newly verified credential-free
official prints, plus two existing-P0 contract updates. New P0s:
**OpenFEMA NFIP redacted claims v3** (`/api/open/v3/NfipClaims`;
**2,724,656** claims; **4,848** `yearOfLoss=2026`; latest loss
**2026-08-03** NJ; `asOfDate` / lastRefresh **2026-08-03** /
**2026-08-04**; v2 `FimaNfipClaims` still deprecated **2026-10-15**
and frozen **2026-06-01** — pin v3, not the old FIMA prefix);
**FAA NASSTATUS airport-status XML** (no key; live closures SNA /
HTS; `Update_Time` **2026-08-30 08:09 GMT**; legacy
`fly.faa.gov/.../xmlAirportStatus.jsp` 301s here);
**BTS Supply Chain and Freight Indicators** (`y5ut-ibwt`; **26,373**
rows; dated through **2026-08-25**; containerships awaiting berth /
anchored, rail dwell, TEUs, truck spot rates); **OpenFEMA Housing
Assistance** owners **160,415** / renters **148,286** (lastRefresh
**2026-08-29**); and **NCHS provisional mortality** `r8kw-7aab`
(promoted from P1; US week **33** ending **2026-08-22** total
deaths **24,647**; `data_as_of` **2026-08-27**). **Existing-P0
updates:** CRSS **2024** National CSV is now live (#299; ~50.89 MB;
`accident.csv` **51,658** data rows; LM **2026-04-01**); EIA-860M
**July 2026** workbook is now live (#286; ~13.93 MB; LM
**2026-08-25 17:08**). **Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` **red** 0/8 this Sunday morning (generated
**2026-08-30T08:04:27Z**; calendar age ~59h — weekend lag, not a
source outage); GLEIF **3,416,159** LEIs (golden copy
**2026-08-29T16:00:00Z**; publishes **2026-08-30** 3,416,322
records); UK Sanctions List report date advanced to
**28-Aug-2026** (LM **2026-08-28 09:39**); CISA KEV
catalogVersion **2026.08.27** (**1,685**); FINRA CNMS **20260828**
live (~538 KB; LM **2026-08-28 21:17**; 20260829 weekend
AccessDenied); OCC **20260828** CSV live (~4.62 MB); Fear & Greed
**69** Greed; Coin Metrics BTC **2026-08-29** ~78244; NY Fed SOFR
**2026-08-27** 3.64%; OpenSanctions ~291.5k (updated
**2026-08-30**); CFTC TFF/CIT advanced to **2026-08-25**; PredictIt
**187** / SGX **899**; FEC `weball26.zip` LM **2026-08-30 05:50**
(~193 KB); DOL ETA 539 through **2026-08-22** (LM **2026-08-29
19:51**); BTS border still **275,901**; Senate LDA **503**
maintenance this run; NSF Aug **2,076** / YTD **6,466**; CDC NSSP
still **651,372** / `week_end` **2026-08-22**; House eFD **1,581**
TSV lines, latest filing **2026-08-27**; ClinicalTrials recruiting
**65,315** / 2026+ starts **32,469**; NIH FY2026 still **51,759**;
Storm Events stamp still **c20260819**; DailyMed **158,947**
labels (`db_published_date` **Aug 28, 2026 08:00 PM EST**);
RxNorm still **03-Aug-2026**; SPC `today.csv` LM **2026-08-30
08:00**; NIFC current incidents **561**; FRED `DGS10`
**2026-08-27** 4.67 / `SP500` **2026-08-28** 7711.76.
**Still blocked / watch:** NCUA `call-report-data-2026-06.zip`
still 404; `cbp24*` still 404; QPC Q2 2026 still unpublished;
FARS 2025 still 404; EIA-860M August 2026 still HTML redirect;
CDC NWSS latest `date_end` still **2025-09-07** (stale — P1);
PHMSA `phmsa.dot.gov` HTML **403** here (catalog href only);
FRA security events `65fa-qbkf` live but keep P1 (narrative
PII / suicide text); FDA `ndctext.zip` still fold #168; OFAC
`cons_prim.csv` still extend the US sanctions adapter.
...
- **Implementation:** upsert `(group, state, week_ending_date or
  ...
  Distinct from still-stale NWSS wastewater (P1).
...
8. **Cyber, physical, climate, and country risk:** CISA KEV + FIRST EPSS + OSV.dev + CIRCL CVE +
   ...
   provisional mortality (#306) + IMF PortWatch
...
and downloaded the response body on **2026-08-30 UTC** (prior 2026-08-27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
notes retained where still accurate). FinUties `GET /health` returned `{"status":"online"}` and
`GET /api/v1/status/p0` was **red** (0/8 domains green) at probe time — weekend freshness lag
(calendar age ~59h), not an upstream-source outage.
