...
**New in this review (2026-08-27):** six newly verified credential-free
official prints sitting outside yesterday's NIH / EIA MER / ClinicalTrials
/ Storm Events / House eFD / FARS cluster — **NLM DailyMed SPL API**
(no key; paginated JSON; **158,889** labels; `db_published_date`
**Aug 26, 2026 07:40:06PM EST**; sample `setid`
`1d2108fa-4352-4f3f-9314-732ed8b6394c` Rising Pharma phenoxybenzamine);
**NLM RxNorm REST** (no key; version **03-Aug-2026** / API **3.1.355**;
aspirin RxCUI **1191**; Lipitor NDC `00071015523` ACTIVE → RxCUI
**617314**); **NOAA SPC storm reports** (`today.csv` **90** lines /
`yesterday.csv` **95**; hail **12** / wind **82**; LM **2026-08-26
23:50**); **NHTSA CRSS 2023 National CSV** (~49.55 MB ZIP; **29**
members; `accident.csv` **50,103** rows / ~33.5 MB; LM **2026-02-04**;
sample CASENUM **202304632910**); **MSHA Accidents** (`Accidents.zip`
~52.1 MB → `Accidents.txt` ~228 MB / **274,449** lines; **3,394**
calendar-2026 rows; LM **2026-08-21 11:08**; Mines / Violations /
AddressOfRecord ZIPs fold); and **NIFC WFIGS current incidents**
(ArcGIS FeatureServer; **659** incidents; sample UniqueFireIdentifier
**2026-FLFNF-000456** Foster Bridge FL, 675 acres, 100% contained).
**FRED:** added `DGS3` / `DGS6MO` / `EFFR` / `OBFR` / `TOTBKCR` /
`M2REAL` / `UNRATENSA` / `CSUSHPINSA`. Do **not** add `TGCR` / `BGCR`
/ `REALIN` (bot-challenge HTML this run). **Re-verified:** FinUties
`/health` online and `/api/v1/status/p0` **green** 8/8 (generated
**2026-08-27T08:05:40Z**); GLEIF **3,412,876** LEIs (golden copy
**2026-08-26T16:00:00Z**; publishes **2026-08-27** 3,413,543 records);
UK Sanctions List still **20-Aug-2026**; CISA KEV catalogVersion
**2026.08.26** (**1,682**); FINRA CNMS **20260826** now live (~536 KB;
LM **2026-08-26 21:17**); OCC **20260826** CSV live (~4.56 MB);
Fear & Greed **71** Greed; Coin Metrics BTC PriceUSD **2026-08-26**
~78955; NY Fed SOFR **2026-08-25** 3.66%; OpenSanctions ~291.5k
(updated **2026-08-27**); CFTC TFF/CIT still **2026-08-18**;
PredictIt **187** markets / SGX **899** / Malaysia CPI / Dallas Fed
WEI (LM still **2026-08-20**) still live; FEC `weball26.zip`
refreshed **2026-08-27 05:36** (~193 KB); DOL ETA 539 LM
**2026-08-26 19:51** (still through **2026-08-15**); BTS border
count still **275,901**; Senate LDA **1,976,414** filings /
**56,082** in 2026 (latest **2026-08-26T15:51:56-04:00**, CHECKMATE
GOVERNMENT RELATIONS / MOREHEAD CAIN FOUNDATION); NSF Aug window
**2,028** / YTD **6,418**; CDC NSSP **651,372** rows and `week_end`
advanced to **2026-08-22**; House eFD **1,580** TSV lines, latest
filing **8/25/2026**; ClinicalTrials recruiting **65,276** / 2026+
starts **32,152**; NIH FY2026 still **51,759** / Aug `date_added`
still **10,665**; Storm Events stamp still **c20260819**; IRS
`eo1.csv` LM still **2026-08-10**; BLS QCEW US Q4 still ~910 KB;
FRED `DGS10` **2026-08-25** 4.64 / `SP500` **2026-08-26** 7675.70.
**Still blocked / watch:** NCUA `call-report-data-2026-06.zip` still
404; `cbp24*` still 404; QPC Q2 2026 still unpublished; OCC
derivatives Q2 2026 still 404; CDC NWSS `2ew6-ywp6` latest
`date_end` still **2025-09-07** (stale — P1); FARS 2025 / CRSS 2024
paths 404; OpenFEMA NFIP Claims v2 live but **deprecated 2026-10-15**
(P1); FDA `ndctext.zip` live — fold into openFDA #168, not a
parallel P0; OFAC `cons_prim.csv` live — extend existing US
sanctions adapter.
...
- **Terms/risk:** NCUA attribution; multi-file schema drift each cycle — keep `AcctDesc`
  versioned with the quarter. June 2026 ZIP still unpublished as of 2026-08-20.
...
### 270. Census Quarterly Survey of Plant Capacity Utilization (QPC) Q1 2026 *(new)*
...
- **Entry point (current quarter):**
  `GET https://www2.census.gov/programs-surveys/qpc/tables/2026/2026-qtr-table-final-q1.xlsx`
  (~65 KB; LM **2026-06-15**)
...
- **Terms/risk:** quarterly, ~2–3 month lag. Census + FRB attribution.
  Sheet/title strings can shift — canary the "Quarter 1" shared string.
...
- **Entry points (no API key):**
  ...
  - Monthly 860M: `GET https://www.eia.gov/electricity/data/eia860m/xls/june_generator2026.xlsx`
    (~13.86 MB; LM **2026-07-23 16:11**)
...
- **Access:** no authentication; ZIP / XLSX. Some current-year
  filenames 301 then Akamai **503** (July 2026 860M;
  `xls/f923_2025.zip`) — pin the last 200 URL, not the landing-page
  redirect.
- **Verified 2026-08-25:** EIA-860 2024 members include
  `2___Plant_Y2024.xlsx`, `3_1_Generator_Y2024.xlsx`,
  `3_2_Wind_Y2024.xlsx`, `3_3_Solar_Y2024.xlsx`,
  `3_4_Energy_Storage_Y2024.xlsx`, `4___Owner_Y2024.xlsx`. June 2026
  860M is the latest monthly workbook that returned 200.
- **Implementation:** checksum workbooks; start with 860 plant +
  generator + June 860M; add 861 sales/customers and 923 generation
...
- **Entry points (no API key; discover current `cYYYYMMDD` stamp
  ...
  - 2026 details: `.../StormEvents_details-ftp_v1.0_d2026_c20260819.csv.gz`
    (~4.85 MB / **28,842** lines; LM **2026-08-19 22:22**)
  - 2026 fatalities: `.../StormEvents_fatalities-ftp_v1.0_d2026_c20260819.csv.gz`
    (~3.1 KB / **243** lines)
  - 2025 details (same stamp): `.../d2025_c20260819.csv.gz`
...
- **Access:** no authentication; gzip CSV. Filename stamp
  (`c20260819`) changes when NCEI republishes — list the directory
  rather than hard-coding yesterday's stamp (`c20260801` 404).
...
- **Value:** official Crash Report Sampling System — nationally
  ...
  *census* only.
- **Entry points (no API key):**
  - Current: `GET https://static.nhtsa.gov/nhtsa/downloads/CRSS/2023/CRSS2023CSV.zip`
    (~49.55 MB; LM **2026-02-04 01:48**)
- **Docs:** https://www.nhtsa.gov/crash-data-systems/crash-report-sampling-system
- **Access:** no authentication; ZIP of CSVs. Guessed
  `CRSS/2024/CRSS2024NationalCSV.zip` and `.../National/` twins
  **404** — pin the 2023 object until a 2024 key appears. HTML
  file-downloads index still 403 here.
- **Verified 2026-08-27:** **29** ZIP members. `accident.csv`
  ~33.49 MB / **50,103** rows. Header starts
  `CASENUM,PSU,PSU_VAR,...,WEIGHT,...,YEAR,...`. Sample CASENUM
  **202304632910**, Midwest urban, January 2023 Sunday 3am, first
  harmful event mailbox, weight **210.86**.
...
| NCUA 5300 Call Report quarterly ZIP | `https://ncua.gov/files/publications/analysis/call-report-data-YYYY-MM.zip` | **Promoted to P0 #244** (`2026-03` live; `2026-06` still 404 on 2026-08-23). |
...
| Census QPC Q1 2026 workbook | `.../qpc/tables/2026/2026-qtr-table-final-q1.xlsx` | **Promoted to P0 #270**. Time Series `programCode=QPC` is empty. Q2 2026 still unpublished (2026-08-23). |
...
| EIA-860 / 860M / 861 / 923 files | `eia.gov/electricity/data/eia860/xls/eia8602024.zip` + 860M June 2026 XLSX | **Promoted to P0 #286**. July 2026 860M and current `f923_2025.zip` 503 this run. |
...
| NIH RePORTER v2 | `https://api.reporter.nih.gov/v2/projects/search` | **Promoted to P0 #290** (POST JSON; 51,759 FY2026 / 76,271 FY2025). ExPORTER CSV links stay opaque — API is the hot path. |
...
| NHTSA CRSS 2023 National CSV | `static.nhtsa.gov/nhtsa/downloads/CRSS/2023/CRSS2023CSV.zip` | **Promoted to P0 #299** (~49.55 MB / 50,103 accident rows; LM 2026-02-04). CRSS 2024 paths 404. |
...
| NCHS provisional mortality `r8kw-7aab` | `https://data.cdc.gov/resource/r8kw-7aab.json` | **23,436** rows; US week 32 ending **2026-08-15** total deaths 20,897; `data_as_of` 2026-08-20. Useful after NSSP #288 — keep P1 until a weekly adapter is scoped. |
| OpenFEMA NFIP Claims v2 | `https://www.fema.gov/api/open/v2/FimaNfipClaims?$top=1` | Live JSON but **deprecated 2026-10-15**. v1 404. Pin the replacement entity before P0. |
| CDC NWSS wastewater | `https://data.cdc.gov/resource/2ew6-ywp6.json` | **837,382** rows live but latest `date_end` still **2025-09-07** (2026-08-27) — stale vs NSSP. Keep P1 until a 2026 observation appears. |
...
5. **Commodities, energy, housing, credit:** World Bank Pink Sheet + IMF Primary Commodity Prices +
   ...
   DHHNGSP/MORTGAGE15US/GASDESW allowlist companions.
...
8. **Cyber, physical, climate, and country risk:** CISA KEV + FIRST EPSS + OSV.dev + CIRCL CVE +
   ...
   reports (#298) + NHTSA CRSS (#299) + MSHA accidents (#300) +
   NIFC WFIGS (#301) + IMF PortWatch
...
and downloaded the response body on **2026-08-27 UTC** (prior 2026-08-26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
notes retained where still accurate). FinUties `GET /health` returned `{"status":"online"}` and
`GET /api/v1/status/p0` was **green** (8/8 domains) at probe time.
