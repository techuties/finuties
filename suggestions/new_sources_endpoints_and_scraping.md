...
**New in this review (2026-09-19):** six newly verified
credential-free official prints. New P0s:
**CDC provisional respiratory deaths by
demographics** (`53g5-jf7x`; **21,744**;
**1,728** in 2026; week ending **2026-09-05**
US males COVID **0.14%** / 22 of 15,551
deaths — the age/sex/race cube that
national-only `4bc2-bbpq` does not carry);
**NCHS monthly COVID-19 deaths by
jurisdiction and demographics**
(`yrur-wghw`; **71,280**; **7,128** in 2026;
`data_as_of` **2026-09-17**; Jan 2026 US
female **1,066** / male **989** — fold weekly
`mpx5-t7tu`, US week ending **2026-09-12**
**47** deaths / 0.2%); **CDC Traveler
Genomic Surveillance COVID nasal
positivity** (`9ikp-t8tw`; **189**; **35**
in 2026; week **2026-08-30** **0.55%** on
**6,042** travelers — fold lineage companion
`b5wa-ze9s`, **13** biweeks, XFG **41%** as
of **2026-08-16**); **CDC RESP-NET
hospitalization rates** (`kvib-3txy`;
**124,148**; **12,984** in 2026; week
**2026-09-05** FluSurv-NET overall weekly
**0.2** observed / **0.3** estimated per
100,000 — un-fold from NHSN #309; fold
COVID-NET `6jg4-xsqq` **495,708** and
RSV-NET `29hc-w46k` **507,114**); **CDC
NNDSS weekly notifiable diseases**
(`x9gk-5huc`; **promoted from P1**;
**1,983,240**; **302,400** in 2026; week
**36** / **2026**; US residents measles
indigenous current-week **101**); and **CDC
BRFSS prevalence** (`dttw-5yxu`;
**3,211,643**; **215,170** in **2025**;
Alaska depression **21.96%** — the adult
survey cube NIS-FRVM #P1 does not carry).
**Existing-P0 updates:** OpenFEMA PA funded
details **849,314** (was 849,279); Mission
Assignments **43,872** (was 43,857); HMA
subapplications **63,561** (was 63,558); PA
grant-award activities **1,223,488** (was
1,223,398); Plan statuses **36,760** (was
36,746); IA multiple-loss flood
**1,117,026** (was 1,116,832); HMA FinTx
**141,816** (was 139,031); DOT TOC
**3,411** (was 3,393); GLEIF **3,434,832** /
golden copy **3,435,415**; Senate LDA
**1,977,043** / **56,682** in 2026; NSF Sep
**107** / YTD **6,586**; House eFD **1,666**
TSV; ClinicalTrials recruiting **64,835** /
2026+ starts **34,731**; DailyMed
**159,279**; NDBC **892** stations (was
844); Fear & Greed **71** Greed;
OpenSanctions **300,960**; CDC WVAL
**561,132** (was 557,421); flu WW
**328,045** (was 326,017); NHSN **21,373**
(was 21,306; official now week
**2026-09-12**); COVID WW **617,349** (was
615,264); RSV WW **308,738** (was 306,663);
H5 **121,533** (was 120,722); ED conditions
**11,858** (was 11,781; week **2026-09-12**
infant URI **12.1%**).
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` domains **green** 6/7 +
economics **unknown** (`probe_timeout`;
generated **2026-09-19T08:03:16Z**); overall
**yellow** — positioning recovered
(`report_date` **2026-09-15**,
`data_age_hours` **104h** inside the 192h
weekly COT budget); GLEIF golden copy
**2026-09-19T00:00:00**; CISA KEV
**2026.09.18** (**1,716**); FINRA CNMS
**20260918** live (~544 KB); OCC **20260918**
CSV live; Coin Metrics BTC **2026-09-18**
~80944; NY Fed SOFR **2026-09-17** 3.85%;
CFTC TFF/CIT **2026-09-15**; UK Sanctions
List still **11-Sep-2026**; PredictIt
**190** / SGX **906**; FEC `weball26.zip`
LM **2026-09-19 05:46**; DOL `ar539.csv` LM
**2026-09-18 19:51**; FRED `DGS10`
**2026-09-17** 4.94 / `SP500` **2026-09-17**
7637.76; SPC `today.csv` LM **2026-09-19
07:58**; FAA NASSTATUS **200** this run
(was 403); NSSP weekly still **660,951** /
daily still **301,392**; overdose still
**86,904**; NFIP claims **2,725,989** /
policies **74,739,464**.
**Folds this run:** COVID-NET `6jg4-xsqq`
and RSV-NET `29hc-w46k` into RESP-NET
#346; weekly COVID deaths `mpx5-t7tu`
into monthly #344; TGS lineages
`b5wa-ze9s` into traveler positivity
#345; NHSN detailed census `rhwp-grxi`
(**6,409**; week **2026-09-12**) into
official #309 (now caught up to the
2026-09-12 prelim); national respiratory
deaths `4bc2-bbpq` still fold #306 beside
the new demographic cube #343.
...
| data.medicaid.gov metastore | `https://data.medicaid.gov/api/1/metastore/schemas/dataset/items` | Live (**554** datasets; LM 2026-09-14). Discovery index — curate a hot-path download before P0 (CMS PDC is #287). |
...
and downloaded the response body on **2026-09-19 UTC** (prior 2026-09-18/17/16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
...
(`probe_timeout`; generated **2026-09-19T08:03:16Z**); overall **yellow** because
economics content is unmeasured, not because COT is stale (`report_date` **2026-09-15**,
`data_age_hours` **104h** inside the 192h budget).
