...
**New in this review (2026-08-26):** five newly verified credential-free
official prints plus one P1 promotion, sitting outside yesterday's USDA
PSD / EIA-860 / CMS Hospital Compare / CDC NSSP / NSF cluster —
**NIH RePORTER API v2** (no key; POST JSON; **51,759** FY2026 projects /
**76,271** FY2025; **10,665** `date_added` 2026-08-01–08-26; sample
`appl_id` **11241160** Dana-Farber K01 $150,722, notice **2026-04-27**);
**EIA Monthly Energy Review CSVs** (data-browser `csv.php?tbl=T0x.xx`;
T01.01 primary energy through **202604**; T09.01 crude RAC through
**202605** $97.7/bbl; T11.01 CO2 through **202604**; T03.01 petroleum
products supplied through **202606**); **ClinicalTrials.gov v2**
**(promoted)** (`countTotal=true`; **65,252** recruiting / **31,989**
started 2026+; sample `NCT07401147`); **NOAA NCEI Storm Events**
(`StormEvents_details-ftp_v1.0_d2026_c20260819.csv.gz` ~4.85 MB /
**28,842** lines; fatalities companion **243** rows; LM **2026-08-19**);
**House Clerk financial-disclosure index** (`2026FD.zip` ~56.6 KB →
`2026FD.txt` **1,574** lines + XML twin; LM **2026-08-25**; latest
filing date **8/21/2026**); and **NHTSA FARS 2024 National CSV**
(~32.67 MB ZIP; member `accident.csv`; LM **2026-04-01**). **FRED:**
`fredgraph.csv` recovered this run — added `SP500` / `NASDAQCOM` /
`DHHNGSP` / `MORTGAGE15US` / `JTSLDL` / `JTSHIR` / `TEMPHELPS` /
`MANEMP` / `GASDESW` / `DEXCAUS` / `NONREVSL`. **Re-verified:**
FinUties `/health` online and `/api/v1/status/p0` **green** 8/8;
GLEIF **3,411,670** LEIs (golden copy **2026-08-26**, 3,412,365
records); UK Sanctions List still **20-Aug-2026** (LM **2026-08-20
11:08**); CISA KEV catalogVersion **2026.08.25** (1,676); FINRA CNMS
**20260825** live (LM **2026-08-25 21:17**; **20260826** AccessDenied);
OCC **20260825** CSV live (~4.80 MB); Fear & Greed **65** Greed; Coin
Metrics BTC PriceUSD **2026-08-25** ~78601; NY Fed SOFR **2026-08-24**
3.65%; OpenSanctions ~291.5k (updated **2026-08-26**); CFTC TFF/CIT
still **2026-08-18**; PredictIt **190** markets / SGX **897** /
Malaysia CPI / Dallas Fed WEI (LM still **2026-08-20**) still live;
FEC `weball26.zip` refreshed **2026-08-26 05:49** (~193 KB); DOL ETA
539 LM **2026-08-25 19:51** (still through **2026-08-15**); BTS border
count still **275,901**; Senate LDA **1,976,382** filings / **56,051**
in 2026 (latest **2026-08-25T17:13:37-04:00**, CAPITOL PATH
CONSULTING LLC / APRICUS ENERGY PARTNERS); NSF Aug window **2,004** /
YTD **6,394**; IRS `eo1.csv` LM still **2026-08-10**; BLS QCEW US Q4
still ~910 KB. **Still blocked / watch:** NCUA
`call-report-data-2026-06.zip` still 404; `cbp24*` still 404; QPC Q2
2026 still unpublished; OCC derivatives Q2 2026 still 404; CDC NWSS
`2ew6-ywp6` latest `date_end` still **2025-09-07** (stale — P1);
Trade.gov CSL download 404 / `api.trade.gov` TLS expired; EIA-860M
July 2026 and current EIA-923 2025 paths still redirect/503; OSHA
`enforcedata.dol.gov` and SBA CKAN guessed APIs still HTML/404.
...
| CDC NWSS wastewater | `https://data.cdc.gov/resource/2ew6-ywp6.json` | **837,382** rows live but latest `date_end` still **2025-09-07** (2026-08-25) — stale vs NSSP. Keep P1 until a 2026 observation appears. |
...
2. **US markets microstructure & banking:** TreasuryDirect auctions + FINRA Reg SHO short volume +
   ...
   (#292) + House Clerk eFD (#294) + NCUA Call Report (#244)
...
and downloaded the response body on **2026-08-26 UTC** (prior 2026-08-25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
