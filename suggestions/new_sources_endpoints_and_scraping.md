...
**New in this review (2026-09-23):** six newly verified
credential-free official prints. New P0s:
**NY Fed repo and reverse-repo operations**
(2026-09-22 overnight reverse repo accepted
**$453m** at **3.75%**; standing repo
accepted **$0** against a **4.00%**
offering rate); **NY Fed primary dealer
statistics** (series break **SBN2024**;
as-of **2026-09-09**; **1,539** series;
Treasury ex-TIPS `PDPOSGST-TOT`
**460,449**; agency MBS `PDPOSMBS-TOT`
**127,221**; Treasury repo
`PDSORA-UTSETTOT` **3,026,625** /
reverse repo `PDSIRRA-UTSETTOT`
**2,723,658** — published units are
millions of USD); **NY Fed Treasury
securities operations** (2026-09-17
outright bill purchase accepted
**$3.891bn** of **$34.034bn** submitted;
the 2026-08-14 agency MBS specified-pool
sale folds here); **NY Fed SOMA
securities lending** (2026-09-22 accepted
**$38.311bn** par of **$38.336bn**
submitted, overnight); **NY Fed U.S.
dollar liquidity swaps** (ECB trade
**2026-09-16**, **$72m** at **4.11%**,
7-day, matures **2026-09-24**); and
**DOL EBSA Form 5500** (2025 latest ZIP,
Last-Modified **2026-08-31**; **82,878**
filings / **51,940,285** active
participants; Schedule H **12,146** rows,
raw end-of-year assets **$5.090tn**).
**Existing-P0 updates:** OpenFEMA PA funded
details **849,155** (was 849,298); HMA
subapplications **63,564** (was 63,562);
plan statuses **36,740** (was 36,776);
IA multiple-loss flood **1,117,545**
(was 1,117,415); HMA FinTx **141,977**
(was 141,945); Mission Assignments
**43,908** (was 43,890); NFIP claims
still **2,725,989** / policies still
**74,739,464**; DOT TOC **3,484**
(was 3,467); GLEIF **3,438,747**
(was 3,436,618); Senate LDA **1,977,132**
/ **56,769** in 2026; OpenSanctions
**300,997** (was 300,974); Coin Metrics
BTC **2026-09-22** **86205.27** (was
2026-09-21 86505.30). House eFD **1,685**
TSV lines; ClinicalTrials recruiting
**64,958** / 2026+ starts **35,119**;
Fear & Greed **71** Greed (was 78 Extreme
Greed). BTS freight **26,652** (was
26,597) / border **276,421** (was
275,901).
...
**2026-09-23T08:06:58Z**); overall
**yellow** with `content_stale` **1** —
positioning COT `report_date` still
**2026-09-15**, `data_age_hours` **200h**
outside the 192h weekly budget (next
Friday release is still ahead). Filings
are inside budget (**8h** vs 48h, latest
**2026-09-23**) and rates are inside
budget (**32h** vs 72h, latest
**2026-09-22**). GLEIF golden copy publish
**2026-09-23 00:00:00** (file
`record_count` **3,438,747**); CISA KEV
**2026.09.22** (**1,721**; CVE-2026-93952
added **2026-09-22**); FINRA CNMS
**20260922** live (LM **2026-09-22 21:18**;
**20260923** not published); OCC
**20260922** CSV live (`actdate`
09/22/2026); NY Fed SOFR **2026-09-21**
3.85% (volume **$2,912bn**); UK Sanctions
List still **21-Sep-2026** (LM
**2026-09-21 12:51**); PredictIt **193** /
SGX **906**; FEC `weball26.zip` LM
**2026-09-23 05:48**; DOL `ar539.csv` LM
**2026-09-22 19:50** (through week
**2026-09-12**); FRED `DGS10`
**2026-09-21** 4.96 / `SP500`
**2026-09-22** 7764.64; SPC `today.csv`
LM **2026-09-23 07:58**; NDBC LM
**2026-09-23 08:05**; SOMA as-of still
**2026-09-16**; FAA NASSTATUS still
**403**.
**Folds this run:** agency MBS outright
results (last specified-pool sale
**2026-08-14**, accepted current face
**$74.0m**) into Treasury operations
#369; Schedule H into Form 5500 #372.
...
**2026-09-15** (LM **2026-09-18**) so
positioning content is now outside the
192h budget; Cboe `totalpc.csv` /
`equitypc.csv` / `indexpc.csv` still end
**2019-10-04** — keep P1 beside VIX #104;
USDA FAS ESR Open Data still not
zero-credential; SOMA as-of has not
moved past **2026-09-16**; Baker Hughes
week still **2026-09-18** until the next
Friday file.
...
- **Docs:** https://markets.newyorkfed.org/static/docs/markets-api.html
- **Access:** no authentication; JSON.
  Overnight reverse repo **2026-09-22** (`RP 092226 26`):
  Treasury submitted and accepted **$453,000,000** at
  **3.75%**, same-day settlement, maturity **2026-09-23**.
  Standing repo the same day (`RP 092226 25`): submitted
  **$0**, accepted **$0**, Treasury offering rate **4.00%**.
...
- **Docs:** https://markets.newyorkfed.org/static/docs/markets-api.html
- **Access:** no authentication; JSON.
  **2026-09-22** (`SL 092226 25`): securities lending, settle
  **2026-09-22**, mature **2026-09-23**, par submitted
  **$38,336,000,000**, par accepted **$38,311,000,000**,
  `lastUpdated` **2026-09-22 12:17:06**.
...
and downloaded the response body on **2026-09-23 UTC** (prior 2026-09-21/20/19/18/17/16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
...
(`probe_timeout` on `im_ecb_observations`; generated **2026-09-23T08:06:58Z**); overall **yellow**
with `content_stale` **1** (positioning). Filings content is **8h** vs 48h and rates **32h** vs 72h
(latest **2026-09-23** / **2026-09-22**). COT is outside the weekly budget
(`report_date` **2026-09-15**, `data_age_hours` **200h** / 192h).
