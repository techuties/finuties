...
**New in this review (2026-09-01):** six newly verified
credential-free official prints. New P0s:
**OpenFEMA HMA Subapplications v2**
(`/api/open/v2/HmaSubapplications`; **63,415** rows;
**142** FY2026 / **1,813** FY2025; the current HMA
project path after v4 projects were deprecated
**2026-10-15**); **OpenFEMA PA grant-award activities**
(`/api/open/v2/PublicAssistanceGrantAwardActivities`;
**1,222,065** rows; **1,341** 2026 declarations;
**26,979** `dateObligated` in 2026); **CDC wastewater
viral activity levels** (`atcp-73re`; **550,582** rows;
week ending **2026-08-22**; SARS-CoV-2 **271,856** /
Influenza A **146,322** / RSV **132,404**); **NIFC
WFIGS current perimeters** (213 polygons; sample
`2026-ALALF-000274` Williams Creek AL); **DOT
Transportation Operations Center incidents**
(`d7ji-htf7`; **3,076** rows, all 2026; latest
**2026-08-31** Houston passenger disturbance); and
**EPA ECHO air/water facilities** (no key; CA air
**2,916** / CA water **31,753**; two-step QueryID).
**Existing-P0 updates:** OpenFEMA PA projects
**848,605** (was 848,204); Mission Assignments
**43,745** (was 43,095); House eFD **1,586** TSV
lines (LM **2026-08-31 13:00**); NSF Aug **2,089** /
YTD **6,479**; Senate LDA **1,976,535**; NDBC
**883** stations (LM **2026-09-01 07:55**); NIFC
incidents **569**; FAA NASSTATUS recovered **200**.
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` **green** 8/8 (generated
**2026-09-01T08:02:29Z** — weekend lag cleared);
GLEIF **3,416,672** LEIs (golden copy
**2026-08-31T16:00:00Z**; publishes **2026-09-01**
3,417,346 records); UK Sanctions List still
**28-Aug-2026** (LM **2026-08-28 09:39**); CISA KEV
**2026.08.31** (**1,687**); FINRA CNMS **20260831**
live (~544 KB; 20260829 Saturday AccessDenied;
20260901 not yet published); OCC **20260831** CSV
live (~4.65 MB; 20260829 Saturday empty);
Fear & Greed **69** Greed; Coin Metrics BTC
**2026-08-31** ~78534; NY Fed SOFR **2026-08-28**
3.65%; OpenSanctions ~291.7k (updated
**2026-09-01**); CFTC TFF/CIT still **2026-08-25**;
PredictIt **185** / SGX **899**; FEC `weball26.zip`
LM **2026-09-01 05:50**; DOL ETA 539 still through
**2026-08-22** (LM **2026-08-31 19:51**); BTS border
still **275,901**; CDC NSSP still **651,372** /
`week_end` **2026-08-22**; ClinicalTrials recruiting
**64,511** / 2026+ starts **32,627**; DailyMed still
**158,947**; RxNorm still **03-Aug-2026**; SPC
`today.csv` LM **2026-09-01 08:01**; FRED `DGS10`
**2026-08-28** 4.73 / `SP500` **2026-08-31** 7686.14;
NFIP v3 still **2,724,656**; NCHS week 33 still
`data_as_of` **2026-08-27**; BTS freight still
through **2026-08-25**; NIH RePORTER FY2026 still
**52,859**. **Still blocked / watch:** NCUA
`call-report-data-2026-06.zip` still 404; `cbp24*`
still 404; QPC Q2 2026 still unpublished; FARS 2025
still 404; EIA-860M August 2026 still unpublished
(July 2026 XLSX still live); CDC NWSS COVID
`2ew6-ywp6` latest `date_end` still **2025-09-07**
(stale — use flu WW #310 + WVAL #315); PHMSA
`phmsa.dot.gov` HTML **403**; FRA `65fa-qbkf` keep
P1 (narrative PII); NNDSS `x9gk-5huc` keep P1
beside NSSP/NHSN/NCHS; FDA `ndctext.zip` still fold
#168; OFAC `cons_prim.csv` still extend the US
sanctions adapter.
...
8. **Cyber, physical, climate, and country risk:** CISA KEV + FIRST EPSS + OSV.dev + CIRCL CVE +
   ...
   ECHO air/water (#318) + IMF PortWatch
...
and downloaded the response body on **2026-09-01 UTC** (prior 2026-08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
notes retained where still accurate). FinUties `GET /health` returned `{"status":"online"}` and
`GET /api/v1/status/p0` was **green** (8/8 domains) at probe time (generated
**2026-09-01T08:02:29Z**).
