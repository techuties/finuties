...
**New in this review (2026-09-16):** six newly verified
credential-free official prints. New P0s:
**OpenFEMA Public Assistance Projects Status**
(`v1/PublicAssistanceProjectsStatus`; **425,963**;
**5,263** with `declarationDate` 2026+; lastRefresh
**2026-09-15** — the live process-status cube beside
staler funded-details #307); **OpenFEMA HMA
Subapplications Financial Transactions**
(`v1/HmaSubapplicationsFinancialTransactions`;
**141,525**; **10,528** in 2026; latest payment
**2026-08-20** $143,640.74 on `DR-4644-0001-R`;
deprecated HMA *Projects* FinTx v1 folds here —
removed **2026-10-15**); **OpenFEMA IHP Valid
Registrations** (`v2/IndividualsAndHouseholdsProgramValidRegistrations`;
**26,220,490**; **289,036** in 2026; lastRefresh
**2026-09-15**; census-tract IHP/HA/ONA amounts —
the microdata path beside housing aggregates #305);
**OpenFEMA Individual Assistance Multiple-Loss
Flood Properties** (`v1/IndividualAssistanceMultipleLossFloodProperties`;
**1,116,540**; **41,364** decl 2025+; IHP-side RL/SRL
distinct from NFIP MLP fold #302); **CDC Wastewater
SARS-CoV-2** (`j9g8-acpt`; **615,264**;
**80,002** collect 2026+; latest
`sample_collect_date` **2026-09-09** Garrett MD
detect yes 24,288 copies/L — the live replacement
for stale NWSS `2ew6-ywp6`); and **CDC VSRR
Provisional Drug Overdose Death Counts**
(`xkb8-kh2a`; **86,265**; through **March 2026**;
US 12-month-ending **66,712** predicted **67,798**).
**Existing-P0 updates:** OpenFEMA PA projects
**849,178** (was 849,013); Mission Assignments
**43,850** (was 43,838); HMA subapplications
**63,549** (was 63,547); PA grant-award activities
**1,223,249** (was 1,223,069); Plan statuses
**36,754** (was 36,745); DOT TOC **3,359**
(was 3,337); BTS freight **26,597** (was 26,500);
GLEIF **3,431,496**; OpenSanctions **300,919**
(was 293,230); Senate LDA **1,976,893**; NSF Sep
**84** / YTD **6,563**; House eFD **1,636** TSV;
ClinicalTrials recruiting **64,718** / 2026+ starts
**34,241**; DailyMed **159,271**; NDBC **879**;
Fear & Greed **51** Neutral.
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` domains **green** 8/8
(generated **2026-09-16T08:22:54Z**) but overall
**yellow** — COT `report_date` **2026-09-08** is
**200h** vs the 192h weekly content budget
(Tuesday morning before the next CFTC print);
GLEIF golden copy **2026-09-16T00:00:00Z**; CISA
KEV still **2026.09.14** (**1,710**); FINRA CNMS
**20260915** live (~546 KB); OCC **20260915** CSV
live; Coin Metrics BTC **2026-09-15** ~75650;
NY Fed SOFR **2026-09-14** 3.62%; CFTC TFF/CIT
still **2026-09-08**; UK Sanctions List still
**11-Sep-2026**; PredictIt **188** / SGX **906**;
FEC `weball26.zip` LM **2026-09-16 05:41**; DOL
`ar539.csv` LM **2026-09-15 19:50**; FRED `DGS10`
**2026-09-14** 4.97 / `SP500` **2026-09-15**
7585.73; SPC `today.csv` LM **2026-09-16 08:17**;
CDC NSSP still **657,758** / WVAL **557,421** /
flu WW **326,017** / NHSN **21,306**; NFIP claims
**2,725,989** / policies **74,739,464**.
**Still blocked / watch:** `cbp24*` still 404;
FARS 2025 still 404; EIA-860M August / September
2026 still electricity-landing HTML; QPC Q3 2026
still 404; CDC NWSS COVID `2ew6-ywp6` still stale
(`date_end` **2025-09-07** — use `j9g8-acpt` #329);
...
beside #318; HMA Mitigated Properties v4 and HMA
*Projects* FinTx v1 deprecated **2026-10-15**
(fold site inventories #313 / FinTx #326);
OpenFEMA firefighter/non-disaster grants FY2026
is only 21 CUAS awards — keep P1; CDC measles WW
`akvg-8vrb` live (72,862 / collect **2026-09-09**)
— fold #329 until a measles product is scoped.
...
and downloaded the response body on **2026-09-16 UTC** (prior 2026-09-15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
notes retained where still accurate). FinUties `GET /health` returned `{"status":"online"}` and
`GET /api/v1/status/p0` domains were **green** 8/8 at probe time (generated
**2026-09-16T08:22:54Z**); overall **yellow** because COT content age
(**200h**, report_date **2026-09-08**) exceeds the 192h weekly budget.
