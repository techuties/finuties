...
**New in this review (2026-09-25):** six newly verified
credential-free feeds. New P0s: **Monthly Statement of the
Public Debt** (statement **2026-08-31**; total public debt
outstanding **40,175,641** million USD, **$40.176tn**; held
by the public **$32.415tn**; intragovernmental **$7.761tn**;
total marketable **$31.828tn**; series from **2001-01-31**,
**4,659** rows); **BPA balancing-authority load and
generation** (5-minute file, Last-Modified **2026-09-25
08:01**; through **2026-09-25 01:00** Pacific; load
**5,928 MW**, VER **1,628**, hydro **3,733**, fossil/biomass
**1,014**, nuclear **1,156**); **SPP real-time generation
mix** (**2026-09-25 07:55Z** total **30,729.0 MW**; wind
**15,134.6** / gas **7,440.4** / coal **6,303.1** / nuclear
**1,837.1** / storage **−344.9**); **AESO current supply
and demand** (update **2026-09-25 02:06**; Alberta internal
load **9,185 MW**; total net generation **10,022 MW**; wind
**2,262**); **USDA AMS boxed-beef cutout** (report
**2026-09-24**; Choice 600–900 **376.12** / Select **352.10**;
**6,469** rows); and **Nord Pool day-ahead system price**
(delivery **2026-09-25**; **96** quarter-hours; SYS
**87.83–177.28** EUR/MWh).
**Existing-P0 updates:** DTS **2026-09-23** TGA close
**947,317** million USD (open **957,409**; deposits
**43,980**; withdrawals **54,071**; `total-count`
**16,638**). SOMA as-of moved to **2026-09-23** (Treasury
bills+notes+TIPS+FRN **$4,452.30bn**, was $4,448.41bn; MBS
**$1,902.99bn**, was $1,906.11bn). Overnight RRP
**2026-09-24** accepted **$630m** at **3.75%** (was $461m);
standing repo afternoon accepted **$1m** at **4.00%**
(morning operation accepted **$0**); securities lending
accepted **$37.940bn** of **$38.575bn** (was $39.130bn /
$42.124bn). New swap drawings trade **2026-09-23**: ECB
**$197m** and Bank of England **$10m**, both at **4.15%**,
mature **2026-10-01** (prior ECB **$72m** at **4.11%**
matured **2026-09-24**). EIA-930 Jul–Dec file
**22,495,925** bytes / **123,672** rows (was 22,234,874 /
122,232); 2026-09-23 hour 24 PJM demand **82,161 MW**. MISO
**2026-09-25 03:00 EST** total **65,139 MW** (was 66,726).
NRC report **2026-09-24**: **95** units, **81** at 100%,
**7** at zero. SOFR **2026-09-23** still **3.87%**, volume
**$2,946bn**. FRED `DGS10` **2026-09-23** **5.11** (was
4.96); `SP500` **2026-09-24** **7704.13**. DOL `ar539.csv`
max `rptdate` advanced to **2026-09-19** (was 2026-09-12).
OpenFEMA PA funded **849,212** (was 849,337); plan statuses
**36,709** (was 36,741); HMA FinTx **142,126** (was
141,996); IA multiple-loss flood **1,117,726** (was
1,117,636); Mission Assignments **43,940** (was 43,920);
HMA subapplications still **63,564**; NFIP claims still
**2,725,989** / policies still **74,739,464**. DOT TOC
**3,530** (was 3,502). GLEIF API **3,441,120** (was
3,439,452); golden-copy file **3,441,948**. Senate LDA
**1,977,225** / **56,858** in 2026. OpenSanctions
**301,183** (was 301,174). Coin Metrics BTC **2026-09-24**
**84386.58** (was 2026-09-23 84434.32). ClinicalTrials
recruiting **65,022** / 2026+ starts **35,411**. CISA KEV
**2026.09.24** count **1,723** (was 1,721). PredictIt
**197** (was 195). BTS freight still **26,652** / border
still **276,421**.
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` heartbeat **green 7/7** (economics
probe no longer times out; `im_ecb_observations` probe
**862 ms**; generated **2026-09-25T08:05:10Z**); overall
**yellow** with `content_stale` **3** — economics latest
**2026-09-11** (**330h** vs 168h), ownership latest
**2026-09-11** (**344h** vs 336h), positioning COT
`report_date` still **2026-09-15** (**248h** vs 192h).
Filings are inside budget (**8h** vs 48h, latest
**2026-09-25**), rates are inside budget (**32h** vs 72h,
latest **2026-09-24**), and equities are inside budget
(**12h** vs 72h, latest **2026-09-24**). GLEIF golden copy
publish **2026-09-25 00:00:00**; FINRA CNMS **20260924**
live (LM **2026-09-24 21:18**; **20260925** AccessDenied);
OCC **20260924** CSV live (`actdate` 09/24/2026; 20260925
says the date cannot exceed 09/24/2026); UK Sanctions List
LM still **2026-09-21 12:51**; SGX **906**; FEC
`weball26.zip` LM **2026-09-25 05:46**; Fear & Greed **71**
Greed (timestamp **2026-09-25**); SPC `today.csv` LM
**2026-09-25 08:00**; NDBC LM **2026-09-25 07:55**; MTS
table 1 still statement **2026-08-31** (`total-count`
**3,117**); primary-dealer market share still Q2 2026
released **2026-07-09**; Baker Hughes NA file still week
**2026-09-18** (UUID unchanged at 08:05 UTC; the Friday
file was not up yet); FAA NASSTATUS still **403**.
**Folds this run:** MSPD CUSIP detail table 3 (**219,321**
rows, same statement date) into #379; AESO asset rows in
the same CSV into #382; other AMS cutout sections into #383;
other Nord Pool `deliveryArea` values into #384. SOMA
`summary.json` stays inside holdings #361. `debt_to_penny`
and average interest rates stay out of scope (terminal
Treasury stack). EIA-930 interchange and subregion stay
inside #376.
**Still blocked / watch:** OpenFEMA
`PublicAssistanceProjectsStatus` (#325) still **404** HTML;
FAA NASSTATUS #303 still **403**; PJM `api.pjm.com`
gen-by-fuel **401** and ISO-NE genfuelmix **401** — not
zero-credential; USACE CWMS catalog is live (**30,734**
NWDP series) but a Grand Coulee name query returned an
empty page, so it stays P1; guessed Treasury-buyback Fiscal
Data paths **404**. CFTC TFF/CIT still **2026-09-15**, so
positioning content is further outside the 192h budget.
Baker Hughes week still **2026-09-18** until the Friday
2026-09-25 file appears. Economics content is now measured
and stale (latest **2026-09-11**), which is why
`content_stale` rose from 1 to 3 even though the economics
...
- **Docs:** https://markets.newyorkfed.org/static/docs/markets-api.html
- **Access:** no authentication; JSON.
  Overnight reverse repo **2026-09-24** (`RP 092426 26`):
  Treasury submitted and accepted **$630,000,000** at
  **3.75%**, **3** counterparties, maturity **2026-09-25**
  (prior day **$461,000,000**). Standing repo the same day:
  morning `RP 092426 25` accepted **$0**; afternoon
  `RP 092426 27` accepted **$1,000,000** at a **4.00%**
  Treasury offering rate.
...
- **Docs:** https://markets.newyorkfed.org/static/docs/markets-api.html
- **Access:** no authentication; JSON.
  **2026-09-24** (`SL 092426 25`): securities lending, settle
  **2026-09-24**, mature **2026-09-25**, par submitted
  **$38,575,000,000**, par accepted **$37,940,000,000**,
  `lastUpdated` **2026-09-24 12:16:14** (prior day accepted
  **$39,130,000,000** of **$42,124,000,000**).
...
- **Access:** no authentication; JSON. `meta.total-count`
  **16,638**. Oldest row **2005-10-03** (account type
  **Federal Reserve Account**, the pre-TGA label). Latest
  business day **2026-09-23**: TGA opening balance
  **957,409**, deposits **43,980**, withdrawals **54,071**,
  closing balance **947,317**. Published units are **millions
  of USD** (closing TGA **$947.317bn**). On this pull
  `close_today_bal` is null and the amount is in
  `open_today_bal` for every account type, including the
  closing-balance row. Open + deposits − withdrawals is
  **947,318**, one million above the published close.
...
- **Access:** no authentication; CSV. Jul–Dec balance file
  **22,495,925** bytes, Last-Modified **2026-09-24 14:42 GMT**,
  **123,672** rows, **60** balancing authorities (one more
  day, **1,440** rows). Demand is populated through
  **2026-09-23** hour **24**. That hour: PJM demand
  **82,161 MW** / generation **84,718 MW**; ERCO **64,962** /
  **64,834**; CISO **28,359** / **20,513**; MISO **71,490** /
  **71,401**; NYIS **13,939** / **11,441**; ISNE **10,549** /
  **11,589**. Hour 24 on **2026-09-24** is in the file for
  **53** authorities with demand blank.
...
- **Access:** no authentication; JSON. Interval
  **2026-09-25 03:00 EST** (`RefId`), total **65,139 MW**.
  Actuals: coal **21,909**, natural gas **23,219**, nuclear
  **11,933**, wind **2,543**, solar **0**, battery storage
  **−173**, other **−608**, imports **5,535**. The legacy
...
- **Access:** no authentication; pipe-delimited text
  ...
  send Last-Modified. Latest report **2026-09-24**: **95**
  units, **81** at **100%** power, **7** at **0** (Browns
  Ferry 1, D.C. Cook 1, FitzPatrick, McGuire 1, North Anna 2,
  Palisades, Vogtle 2).
...
- **Access:** no authentication; tab-separated text, **77,436**
  bytes, Last-Modified **2026-09-25 08:01 GMT**. Header says
  last updated **25Sep2026 01:01:17** Pacific. Columns are
  `Date/Time`, `Load`, `VER`, `Hydro`, `Fossil/Biomass`,
  `Nuclear`. **1,737** filled intervals in the rolling week.
  Latest filled row **2026-09-25 01:00** Pacific: load
  **5,928 MW**, VER **1,628**, hydro **3,733**, fossil/biomass
  **1,014**, nuclear **1,156**. Later clock rows in the file
...
- **Access:** no authentication; JSON chart payload.
  ...
  **2026-09-25T07:55:00Z** (`lastModifiedDate`
  **2026-09-25 07:55:31Z**). Latest MW: coal **6,303.1**,
  diesel fuel oil **2.0**, hydro **302.3**, natural gas
  **7,440.4**, nuclear **1,837.1**, solar **0.4**, waste
  disposal **9.0**, wind **15,134.6**, waste heat **0.0**,
  energy storage **−344.9**, other **45.0**. Sum of those
  points **30,729.0 MW**.
...
- **Access:** no authentication; quoted CSV when
  ...
  File stamped **"Last Update : Sep 25, 2026 02:06"**.
  Alberta internal load **9,185 MW**. Alberta total net
  generation **10,022 MW**. Net actual interchange **837 MW**
  (British Columbia **661**, Montana **176**, Saskatchewan
  **0**). Fuel total-net-generation: cogeneration **3,868**,
  combined cycle **3,091**, wind **2,262**, gas-fired steam
  **445**, other **209**, hydro **101**, simple cycle **46**,
  solar **0**, energy storage **0**. Those fuel rows sum to
  the **10,022 MW** total.
...
- **Access:** no authentication; JSON. Slug **2453** /
  ...
  **2026-09-24 14:49:43**. Current Cutout Values returned
  **6,469** rows. Latest `report_date` **09/24/2026**:
  Choice 600–900 **376.12**, Select 600–900 **352.10**
  (prior day **377.31** / **352.34**). The LMR cutout unit
...
- **Access:** no authentication; JSON. Delivery date
  **2026-09-25** (`deliveryDateCET`), `updatedAt`
  **2026-09-25T08:07:06Z**, market **DayAhead**, currency
  **EUR**. **96** quarter-hours. SYS prices from **87.83**
  to **177.28** EUR/MWh; the first quarter-hour is
  **134.36**.
...
and downloaded the response body on **2026-09-25 UTC** (prior 2026-09-24/23/21/20/19/18/17/16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
notes retained where still accurate). FinUties `GET /health` returned `{"status":"online"}` and
`GET /api/v1/status/p0` heartbeat was **green 7/7** (economics probe succeeded in **862 ms**; generated **2026-09-25T08:05:10Z**); overall **yellow**
with `content_stale` **3** (economics **330h** vs 168h, ownership **344h** vs 336h, positioning **248h** vs 192h). Filings content is **8h** vs 48h (latest **2026-09-25**),
rates **32h** vs 72h (latest **2026-09-24**), and equities **12h** vs 72h (latest **2026-09-24**). COT `report_date` is still **2026-09-15**.
