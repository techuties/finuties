...
**New in this review (2026-09-26):** six newly verified
credential-free feeds. New P0s: **OMIE Iberian day-ahead
prices** (delivery **2026-09-26**; **96** quarter-hours;
Spanish marginal **0.45–251.08** EUR/MWh, first quarter-hour
**207.72**; **10,842** bytes; issued **2026-09-25 13:41**);
**EirGrid / SONI demand and generation** (updated
**2026-09-26 09:12**; 09:00 system demand **4,697 MW**,
`GEN_EXP` **3,515**, wind **1,837**, net interchange
**1,311**); **Hydro-Québec demand** (**2026-09-26T07:45:00Z**
**14,675 MW**; **112** filled of **192** slots);
**CAMMESA region-1002 demand** (**2026-09-26 05:05** ART
**12,769 MW**; **62** hours with `demHoy` of **289**);
**CME Group futures settlements** (trade **2026-09-25**,
final; WTI NOV 26 **92.41**, volume **345,783**; Henry Hub
OCT 26 **3.196**; gold OCT 26 **4,287.8**); and **Statnett
Nordic production and consumption**
(**2026-09-26T06:45:00Z**; Norway production **16,872 MW** /
consumption **13,866** / hydro **15,494** / wind **1,084**).
**Existing-P0 updates:** DTS **2026-09-24** TGA close
**924,627** million USD (open **947,317**; deposits
**278,110**; withdrawals **300,800**; arithmetic matches;
`close_today_bal` still null; `total-count` **16,642**).
Overnight RRP **2026-09-25** accepted **$576m** at **3.75%**
(was $630m), **3** counterparties, maturity **2026-09-28**;
standing repo morning and afternoon both accepted **$0**
(afternoon was $1m on 2026-09-24). Securities lending
**2026-09-25** accepted **$42.741bn** of **$43.460bn**
(maturity **2026-09-28**). No new liquidity-swap drawing
(ECB **$197m** and Bank of England **$10m** at **4.15%**
still mature **2026-10-01**). SOMA as-of still
**2026-09-23**. EIA-930 Jul–Dec file **22,757,071** bytes /
**125,112** rows (was 22,495,925 / 123,672); 2026-09-24
hour 24 PJM demand **80,771 MW**; 2026-09-25 hour 24 is
present with PJM forecast **77,191 MW** and demand blank.
MISO **2026-09-26 03:05 EST** total **62,114 MW** (was
65,139). NRC report **2026-09-25**: **95** units, **82** at
100%, **7** at zero (same seven units as 2026-09-24). SOFR
**2026-09-24** **3.88%**, volume **$2,990bn** (was 3.87% /
$2,946bn). FRED `DGS10` **2026-09-24** **5.18** (was 5.11);
`SP500` **2026-09-25** **7743.41**. CFTC TFF report date
advanced to **2026-09-22** (was 2026-09-15; LM
**2026-09-25 19:30**). BPA **2026-09-26 01:10** PT load
**5,837 MW**. SPP **2026-09-26 08:05Z** total **30,283.1
MW** (wind **18,720.0**). AESO update **2026-09-26 02:13**;
AIL **9,165 MW**; wind TNG **4,108**. AMS cutout
**2026-09-25** Choice **378.83** / Select **355.76**. Nord
Pool delivery **2026-09-26** SYS **12.00–135.96** EUR/MWh.
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` heartbeat **green 7/7** (economics
probe **6.0 ms**; generated **2026-09-26T08:11:39Z**);
overall **yellow** with `content_stale` **2** — economics
latest **2026-09-11** (**355h** vs 168h), ownership latest
**2026-09-11** (**368h** vs 336h). Positioning is back
inside budget (**104h** vs 192h, COT `report_date`
**2026-09-22**). Filings are inside budget (**8h** vs 48h,
latest **2026-09-26**), rates are inside budget (**32h** vs
72h, latest **2026-09-25**), and equities are inside budget
(**12h** vs 72h, latest **2026-09-25**). GLEIF API
**3,443,418** and golden-copy file **3,443,418**, publish
**2026-09-26 00:00:00**. CISA KEV **2026.09.25** count
**1,726** (CVE-2026-67279, CVE-2026-65660, CVE-2026-87902
added 2026-09-25). FINRA CNMS **20260925** live (LM
**2026-09-25 21:18**; **20260926** AccessDenied); OCC
**20260925** CSV live (20260926 says the date cannot exceed
09/25/2026). UK Sanctions List LM still **2026-09-21
12:51**. FEC `weball26.zip` LM **2026-09-26 05:42**. Fear
& Greed **74** Greed (timestamp **2026-09-26**). Coin
Metrics BTC **2026-09-25** **84062.16**. OpenSanctions
**301,356** (updated 2026-09-26T07:47:01). Senate LDA
**1,977,263** / **56,887** in 2026. ClinicalTrials
recruiting **65,044** / 2026+ starts **35,592**. PredictIt
still **197**. SGX still **906**. OpenFEMA PA funded
**849,234** (was 849,212); plan statuses **36,726** (was
36,709); HMA FinTx **142,323** (was 142,126); Mission
Assignments **43,950** (was 43,940); HMA subapplications
still **63,564**; NFIP claims still **2,725,989** / policies
still **74,739,464**. DOT TOC **3,553** (was 3,530). BTS
freight still **26,652** / border still **276,421**. SPC
`today.csv` LM **2026-09-26 08:13**; NDBC LM **2026-09-26
08:05**. MTS table 1 still statement **2026-08-31**
(`total-count` **3,117**). Primary-dealer market share still
Q2 2026 released **2026-07-09**. FAA NASSTATUS still **403**.
**Folds this run:** OMIE Portugal prices in the same TXT
into #385; EirGrid wind, CO2 intensity, and interconnector
series into #386; Hydro-Québec null future slots stay out
of #387; other CAMMESA region ids into #388; CME Henry Hub
and gold (and further product ids) into #389; Statnett
Sweden, Denmark, Finland, and Baltic rows into #390. EIA-930
interchange and subregion stay inside #376. AMS sections
other than the cutout stay inside #383.
**Still blocked / watch:** OpenFEMA
`PublicAssistanceProjectsStatus` (#325) still **404** HTML.
`IndividualAssistanceMultipleLossFloodProperties` (#328)
still returns HTTP 200, but `$count=true` now reports
metadata count **0** — do not replace the last good count
**1,117,726**. FAA NASSTATUS #303 still **403**. PJM
`api.pjm.com` gen-by-fuel and ISO-NE genfuelmix were **401**
on 2026-09-25 and were not re-probed. Baker Hughes NA page
timed out on the follow-up fetch; the weekly spreadsheet
UUID was not re-isolated, so week **2026-09-18**
(`ad65c983-ab99-42c3-9997-0d3118fc72a4`) stays the pinned
file. USACE CWMS stays P1. Treasury interest expense on
public issues is live (August 2026 notes accrued
**$44.308bn**) and stays P1 beside MTS #374. OTE Czech
day-ahead `@@chart-data` is live chart JSON and stays P1.
Guessed Treasury-buyback Fiscal Data paths were not
retried. Economics content remains stale (latest
**2026-09-11**), which is why `content_stale` is 2 even
though the economics probe succeeded and positioning moved
...
- **Entry points (no API key):**
  ...
  - Treasury: `GET https://markets.newyorkfed.org/api/soma/tsy/get/asof/2026-09-23.json`
  - Agency: `GET https://markets.newyorkfed.org/api/soma/agency/get/asof/2026-09-23.json`
  - MBS: `GET https://markets.newyorkfed.org/api/soma/mbs/get/asof/2026-09-23.json`
- **Docs:** https://markets.newyorkfed.org/static/docs/markets-api.html
- **Access:** no authentication; JSON.
  Latest as-of this run is **2026-09-23**. Summary history
  `/api/soma/summary.json` (**1,212** rows) shows bills +
  notes/bonds + TIPS + FRN **$4,452.30bn** (was **$4,448.41bn**
  on **2026-09-16**), MBS **$1,902.99bn** (was **$1,906.11bn**),
  agencies still **$2.35bn**, total **$6.365tn**. CUSIP counts
  were last taken on the **2026-09-16** book (Treasury **434** /
  MBS **8,387** / agency **8,953**) and were not re-counted
  this run.
...
- **Docs:** https://markets.newyorkfed.org/static/docs/markets-api.html
- **Access:** no authentication; JSON.
  Overnight reverse repo **2026-09-25** (`RP 092526 26`):
  Treasury submitted and accepted **$576,000,000** at
  **3.75%**, **3** counterparties, maturity **2026-09-28**
  (prior day **$630,000,000**). Standing repo the same day:
  morning `RP 092526 25` and afternoon `RP 092526 27` both
  accepted **$0** at a **4.00%** offering rate (prior
  afternoon had accepted **$1,000,000**).
...
- **Docs:** https://markets.newyorkfed.org/static/docs/markets-api.html
- **Access:** no authentication; JSON.
  **2026-09-25** (`SL 092526 25`): securities lending, settle
  **2026-09-25**, mature **2026-09-28**, par submitted
  **$43,460,000,000**, par accepted **$42,741,000,000**,
  `lastUpdated` **2026-09-25 12:16:48** (prior day accepted
  **$37,940,000,000** of **$38,575,000,000**).
...
- **Docs:** https://markets.newyorkfed.org/static/docs/markets-api.html
- **Access:** no authentication; JSON.
  Latest drawings, trade **2026-09-23**, settle
  **2026-09-24**, mature **2026-10-01**, **7** days, rate
  **4.15%**: European Central Bank **$197,000,000** and Bank
  of England **$10,000,000**. The prior ECB drawing
  (**$72,000,000** at **4.11%**, trade **2026-09-16**) matured
  **2026-09-24**.
...
- **Access:** no authentication; JSON. `meta.total-count`
  **16,642**. Oldest row **2005-10-03** (account type
  **Federal Reserve Account**, the pre-TGA label). Latest
  business day **2026-09-24**: TGA opening balance
  **947,317**, deposits **278,110**, withdrawals **300,800**,
  closing balance **924,627**. Published units are **millions
  of USD** (closing TGA **$924.627bn**). On this pull
  `close_today_bal` is null and the amount is in
  `open_today_bal` for every account type, including the
  closing-balance row. Open + deposits − withdrawals equals
  the published close.
...
- **Access:** no authentication; CSV. Jul–Dec balance file
  **22,757,071** bytes, Last-Modified **2026-09-25 14:41 GMT**,
  **125,112** data rows, **60** balancing authorities (one
  more day, **1,440** rows). Demand is populated through
  **2026-09-24** hour **24**. That hour: PJM demand
  **80,771 MW** / generation **84,696 MW**; ERCO **64,865** /
  **64,632**; CISO **28,693** / **19,747**; MISO **70,041** /
  **67,797**. Hour 24 on **2026-09-25** is in the file with
  PJM forecast **77,191 MW** and demand blank — keep blank
  demand as null.
...
- **Access:** no authentication; JSON. Interval
  **2026-09-26 03:05 EST** (`RefId`), total **62,114 MW**.
  Actuals: coal **18,474**, natural gas **18,116**, nuclear
  **10,043**, wind **13,189**, solar **0**, battery storage
  **−76**, other **−72**, imports **2,292**. The legacy
...
- **Access:** no authentication; pipe-delimited text
  (`ReportDt|Unit|Power`), about **1.3 MB**. HEAD did not
  send Last-Modified. The legacy path redirects to the
  document-collections URL and still returns the file
  (**1,317,564** bytes this run). Latest report
  **2026-09-25**: **95** units, **82** at **100%** power,
  **7** at **0** (Browns Ferry 1, D.C. Cook 1, FitzPatrick,
  McGuire 1, North Anna 2, Palisades, Vogtle 2).
...
### 379. Monthly Statement of the Public Debt *(new)*

- **Value:** official month-end composition of US public debt
  by instrument — bills, notes, bonds, TIPS, FRNs, and
  nonmarketable debt — the stock the daily TGA (#373) and the
  monthly receipts/outlays statement (#374) do not split.
  Distinct from `debt_to_penny`, which stays on the terminal
  Treasury stack.
- **Entry point:** `GET https://api.fiscaldata.treasury.gov/services/api/fiscal_service/v1/debt/mspd/mspd_table_1?sort=-record_date&page[size]=20`
- **Detail fold:** `GET https://api.fiscaldata.treasury.gov/services/api/fiscal_service/v1/debt/mspd/mspd_table_3?sort=-record_date&page[size]=5`
- **Docs:** https://fiscaldata.treasury.gov/datasets/monthly-statement-public-debt/summary-of-treasury-securities-outstanding
- **Access:** no authentication; JSON. `meta.total-count`
  **4,659**. Oldest row **2001-01-31**. Latest statement
  **2026-08-31** (**14** lines). Amounts are **millions of
  USD**. Total public debt outstanding: held by the public
  **32,414,988.81**, intragovernmental **7,760,652.32**, total
  **40,175,641.13** (**$40.176tn**). Total marketable
  **31,828,001.46** (**$31.828tn**). Public holdings that
  day: bills **7,247,855.59**, notes **16,214,682.01**, bonds
  **5,512,728.52**, TIPS **2,151,956.99**, floating-rate notes
  **679,918.00**. Table 3 is the CUSIP detail for the same
  statement (**219,321** rows) and folds here.
- **Implementation:** upsert `(record_date, src_line_nbr)` on
  table 1 and `(record_date, security_class2_desc, src_line_nbr)`
  on table 3. Keep header rows whose class is `_`. Do not sum
  every line — the total-outstanding row already aggregates.
  Page with `page[number]` until `total-count`. This is not
  the daily debt total and not MTS table 1.
- **Terms/risk:** US Treasury Fiscal Data. Millions, not
  dollars. A short page must not replace history.

### 380. BPA balancing-authority load and generation *(new)*

- **Value:** official 5-minute load and generation inside the
  Bonneville balancing authority — the Pacific Northwest print
  EIA-930 hourly BA rows (#376) do not carry, and the ISO
  feeds do not cover.
- **Entry point:** `GET https://transmission.bpa.gov/Business/Operations/Wind/baltwg.txt`
- **Docs:** https://transmission.bpa.gov/Business/Operations/Wind/default.aspx
- **Access:** no authentication; tab-separated text, **77,771**
  bytes, Last-Modified **2026-09-26 08:11 GMT**. Columns are
  `Date/Time`, `Load`, `VER`, `Hydro`, `Fossil/Biomass`,
  `  Nuclear`. **1,740** filled intervals in the rolling week.
  Latest filled row **2026-09-26 01:10** Pacific: load
  **5,837 MW**, VER **1,548**, hydro **3,623**, fossil/biomass
  **636**, nuclear **1,151**. Later clock rows in the file
  are blank placeholders, not zeros.
- **Implementation:** checksum and upsert `(timestamp)`. Keep
  blank future rows out of the table. VER is the file's
  variable-energy column (the title calls it wind); do not
  rename it. Generation can exceed load because the BA
  exports. EIA-930 `BPAT` stays the hourly sibling (#376),
  not a duplicate of this 5-minute file.
- **Terms/risk:** BPA / US government public operations data.
  The file is a 7-day window, not an archive. Attribute BPA
  Technical Operations.

### 381. SPP real-time generation mix *(new)*

- **Value:** live Southwest Power Pool generation by fuel, with
  no API key — the south-central ISO gap beside MISO (#377),
  ERCOT (#77), and EIA-930 `SWPP` hourly rows (#376).
- **Entry point:** `GET https://marketplace.spp.org/chart-api/gen-mix/asChart`
  (redirects to `https://portal.spp.org/chart-api/gen-mix/asChart`)
- **Docs:** https://marketplace.spp.org/
- **Access:** no authentication; JSON chart payload.
  `response.labels` are UTC timestamps. Latest label
  **2026-09-26T08:05:00Z**. Latest MW: coal **5,300.5**,
  diesel fuel oil **2.0**, hydro **295.5**, natural gas
  **4,527.3**, nuclear **1,841.0**, solar **0.4**, waste
  disposal **9.1**, wind **18,720.0**, waste heat **0.0**,
  energy storage **−432.0**, other **19.3**. Sum of those
  points **30,283.1 MW**.
- **Implementation:** poll the chart and upsert `(timestamp,
  fuel)`. Keep negative storage. The payload is a chart
  series (about two hours of 5-minute points), not a history
  file — store each poll. Other `chart-api` routes on this
  host fold here after a schema check; start with generation
  mix. EIA-930 `SWPP` remains the hourly settlement-style
  sibling.
- **Terms/risk:** SPP public display data. Label order and
  fuel names can change. This is an operational feed, not
  an archive.

### 382. AESO current supply and demand *(new)*

- **Value:** official Alberta Electric System Operator
  generation, internal load, and interchange, with no API key
  — the Canadian power print IESO (#142) does not cover.
- **Entry point:** `GET http://ets.aeso.ca/ets_web/ip/Market/Reports/CSDReportServlet?contentType=csv`
- **Docs:** http://ets.aeso.ca/ets_web/ip/Market/Reports/CSDReportServlet
- **Access:** no authentication; quoted CSV when
  `contentType=csv` is set. The same URL without that
  parameter is an HTML download interstitial, not the data.
  File stamped **"Last Update : Sep 26, 2026 02:13"**.
  Alberta internal load **9,165 MW**. Alberta total net
  generation **10,052 MW**. Net actual interchange **887 MW**
  (British Columbia **889**, Montana **−2**, Saskatchewan
  **0**). Summary columns are maximum capability, total net
  generation, and dispatched contingency reserve. Total net
  generation: cogeneration **3,570**, wind **4,108**,
  combined cycle **1,788**, gas-fired steam **244**, other
  **193**, hydro **103**, simple cycle **46**, solar **0**,
  energy storage **0**. Those fuel rows sum to the
  **10,052 MW** total.
- **Implementation:** request `contentType=csv` and upsert
  `(report timestamp, asset or fuel)`. Keep the summary fuel
  block and the interchange block on the hot path. Unit rows
  in the same file fold here. Do not treat maximum capability
  as generation.
- **Terms/risk:** AESO public market report. The clock on the
  file is local Alberta time. Asset names and the `*` / `^`
  flags can change.

### 383. USDA AMS boxed-beef cutout *(new)*

- **Value:** official daily negotiated boxed-beef cutout — the
  US wholesale beef price EIA petroleum files and the FAO
  price index do not carry.
- **Entry points (no API key):**
  - Cutout section: `GET https://mpr.datamart.ams.usda.gov/services/v1.1/reports/2453/Current%20Cutout%20Values`
  - Report catalog: `GET https://mpr.datamart.ams.usda.gov/services/v1.1/reports`
- **Docs:** the report catalog above is the discovery index (slug **2453** is `LM_XB403`)
- **Access:** no authentication; JSON. Slug **2453** /
  `LM_XB403`, National Daily Boxed Beef Cutout, published
  **2026-09-25 14:46:09**. Current Cutout Values returned
  **6,470** rows. Latest `report_date` **09/25/2026**:
  Choice 600–900 **378.83**, Select 600–900 **355.76**
  (prior day **376.12** / **352.10**). The LMR cutout unit
  is USD per hundredweight.
- **Implementation:** hot path is slug 2453, section
  `Current Cutout Values`. Upsert `(report_date)`. Store
  `choice_600_900_current` and `select_600_900_current`.
  Other sections on this slug (primals, volume, cuts) and
  sibling LMR slugs discovered from the catalog fold here;
  start with the cutout. The catalog `published_date` is
  the freshness check.
- **Terms/risk:** USDA AMS Livestock Mandatory Reporting.
  PM and AM report variants are different slugs — do not
  overwrite one with the other. Values revise within the day.

### 384. Nord Pool day-ahead system price *(new)*

- **Value:** credential-free Nordic day-ahead power price at
  15-minute grain — the European electricity price ENTSOG gas
  (#47), RTE France (#192), and UK carbon intensity (#143) do
  not publish.
- **Entry point:** `GET https://dataportal-api.nordpoolgroup.com/api/DayAheadPrices?date=2026-09-25&market=DayAhead&deliveryArea=SYS&currency=EUR`
- **Docs:** https://data.nordpoolgroup.com/
- **Access:** no authentication; JSON. Delivery date
  **2026-09-26** (`deliveryDateCET`), `updatedAt`
  **2026-09-26T08:14:11Z**, market **DayAhead**, currency
  **EUR**. **96** quarter-hours. SYS prices from **12.00**
  to **135.96** EUR/MWh; the first quarter-hour is
  **125.03**.
- **Implementation:** poll by delivery date and upsert
  `(deliveryStart, deliveryArea, currency)`. Keep the price
  in the requested currency. Other `deliveryArea` codes on
  this path fold here; start with `SYS`. Do not mix
  currencies in one series. A missing quarter is null, not
  zero.
- **Terms/risk:** Nord Pool data-portal terms. Confirm
  redistribution before a commercial mirror. Prices are
  day-ahead, not imbalance or intraday.


### 385. OMIE Iberian day-ahead prices *(new)*

- **Value:** official Spanish and Portuguese day-ahead
  marginal prices at quarter-hour grain — the Iberian power
  price REE demand (#56) and Nord Pool SYS (#384) do not
  publish.
- **Entry point:** `GET https://www.omie.es/sites/default/files/dados/AGNO_2026/MES_09/TXT/INT_PBC_EV_H_1_26_09_2026_26_09_2026.TXT`
- **Docs:** https://www.omie.es/en/file-access-list
- **Access:** no authentication; semicolon text, European
  decimals. Delivery **2026-09-26**, issued **25/09/2026
  13:41**, Last-Modified **2026-09-25 11:41 GMT**, **10,842**
  bytes. **96** quarter-hours (`H1Q1`…`H24Q4`). Spanish
  marginal price **0.45–251.08** EUR/MWh; the first
  quarter-hour is **207.72**. The Portuguese marginal row
  has the same min and max on this delivery day.
- **Implementation:** build the path from the delivery date
  (`AGNO_YYYY/MES_MM/TXT/INT_PBC_EV_H_1_DD_MM_YYYY_DD_MM_YYYY.TXT`).
  Upsert `(delivery date, quarter, system)`. Parse comma
  decimals. Keep the Portuguese price row in this adapter.
  A missing quarter is null, not zero. REE (#56) stays the
  demand sibling.
- **Terms/risk:** OMIE market results. Confirm redistribution
  before a commercial mirror. Prices are day-ahead, not
  intraday or imbalance.

### 386. EirGrid and SONI demand and generation *(new)*

- **Value:** live all-island Ireland electricity demand,
  generation, wind, and interchange, with no API key — the
  island print GB carbon intensity (#143) and NESO (#196) do
  not cover.
- **Entry points (no API key):**
  - Demand: `GET https://www.smartgriddashboard.com/DashboardService.svc/data?area=demandactual&region=ALL&datefrom=26-Sep-2026+00:00&dateto=26-Sep-2026+09:20`
  - Generation: the same path with `area=generationactual`
  - Wind / CO2 / interconnectors (fold): `area=windactual`,
    `area=co2intensity`, `area=interconnection`
- **Docs:** https://www.smartgriddashboard.com/
- **Access:** no authentication; JSON. `LastUpdated`
  **26-Sep-2026 09:12:20**, `Status` **Success**. At
  **26-Sep-2026 09:00:00**: system demand **4,697 MW**
  (`SYSTEM_DEMAND`), generation **3,515 MW** (`GEN_EXP`),
  wind **1,837 MW** (`WIND_ACTUAL`), net interchange
  **1,311 MW** (`INTER_NET`). CO2 intensity **95** at
  **08:45**. Interconnectors at 09:00: EWIC **356** (ROI),
  Greenlink **513** (ROI), Moyle **442** (NI). The next
  quarter-hour can be null. `area=fuelmix` returned **503**
  on this run.
- **Implementation:** poll bounded local-time windows and
  upsert `(EffectiveTime, FieldName, Region)`. Keep null
  `Value` out of the table. Wind, CO2, and interconnector
  areas fold here; start with demand and `GEN_EXP`. Do not
  rename `GEN_EXP`. A 503 is a retry, not an empty grid.
- **Terms/risk:** EirGrid / SONI public dashboard. The clock
  is local Ireland time. Field names can change.

### 387. Hydro-Québec electricity demand *(new)*

- **Value:** official Québec load at 15-minute grain — the
  Canadian power print IESO (#142) and AESO (#382) do not
  cover.
- **Entry point:** `GET https://donnees.hydroquebec.com/api/explore/v2.1/catalog/datasets/demande-electricite-quebec/records?where=valeurs_demandetotal%20is%20not%20null&order_by=date%20desc&limit=5`
- **Docs:** https://donnees.hydroquebec.com/explore/dataset/demande-electricite-quebec/
- **Access:** no authentication; Opendatasoft JSON. Dataset
  `total_count` **192** slots. Non-null filter returns
  **112** rows. Latest filled point
  **2026-09-26T07:45:00Z**, `valeurs_demandetotal`
  **14,675 MW** (prior slot **14,546**). Later slots in an
  unfiltered pull are null, not zero.
- **Implementation:** upsert `date`. Store only non-null
  `valeurs_demandetotal`. The feed is a short rolling
  window, not an archive — poll it. Do not treat maximum
  capability as load. IESO and AESO stay separate adapters.
- **Terms/risk:** Hydro-Québec open data. Attribute the
  publisher. Null future rows must not be written as zero.

### 388. CAMMESA Argentina electricity demand *(new)*

- **Value:** official 5-minute Argentine system demand and
  temperature for a pinned region — the South American power
  print ONS Brazil (#230) does not cover.
- **Entry point:** `GET https://api.cammesa.com/demanda-svc/demanda/ObtieneDemandaYTemperaturaRegion?id_region=1002`
- **Docs:** https://api.cammesa.com/
- **Access:** no authentication; JSON array, **289**
  timestamps for the local day. **62** rows include
  `demHoy`. Latest actual **2026-09-26T05:05:00-03:00**,
  `demHoy` **12,769 MW** (`demAyer` **13,391**). At local
  midnight, `demHoy` **15,738**, `demPrevista` **15,745**,
  `tempHoy` **17.7**. Later hours omit `demHoy` and keep
  `demPrevista` only.
- **Implementation:** upsert `(fecha, id_region)`. Store
  `demHoy` only when the key is present; a missing key is
  not zero. `demPrevista` is a forecast column, not a
  substitute actual. Other `id_region` values fold here
  after the region map is pinned; start with **1002**. Do
  not call the series a price.
- **Terms/risk:** CAMMESA public demand service. The clock
  is Argentina local time (UTC−3). Region ids need a
  fixture before a national label is shown.

### 389. CME Group futures settlements *(new)*

- **Value:** official daily futures settlements, volume, and
  open interest for crude, natural gas, and gold — the
  exchange print EIA spot files and the World Bank pink
  sheet do not carry at contract grain.
- **Entry points (no API key; `tradeDate` is required as
  `MM/DD/YYYY`):**
  - WTI crude, product **425**: `GET https://www.cmegroup.com/CmeWS/mvc/Settlements/Futures/Settlements/425/FUT?tradeDate=09/25/2026`
  - Henry Hub natural gas, product **444**: `…/444/FUT?tradeDate=09/25/2026`
  - Gold, product **437**: `…/437/FUT?tradeDate=09/25/2026`
- **Docs:** https://www.cmegroup.com/markets/energy/crude-oil/light-sweet-crude.settlements.html
- **Access:** no authentication; JSON. Trade date
  **09/25/2026**, `reportType` **Final**. A date without
  slashes returns an empty `settlements` array. Crude
  (`Crude Oil Future`): **125** rows; NOV 26 settle
  **92.41**, change **−2.20**, volume **345,783**, open
  interest **304,677**. Henry Hub: **148** rows; OCT 26
  settle **3.196**, volume **104,862**; NOV 26 settle
  **3.225**, open interest **451,131**, volume **339,434**.
  Gold: **35** rows; the first listed month SEP 26 has
  volume **13** and settle **4286.2**; OCT 26 settle
  **4287.8**, volume **15,997**, open interest **28,317**.
- **Implementation:** pass `tradeDate=MM/DD/YYYY` and upsert
  `(productId, tradeDate, month)`. Keep `settle`, `volume`,
  and `openInterest` as published text until commas are
  stripped. An empty `settlements` array means the date
  format or the session is wrong — do not delete the prior
  final. Other product ids on this path fold here; start
  with **425**, **444**, and **437**. Do not treat SEP gold
  as the liquid contract when its volume is a handful of
  lots.
- **Terms/risk:** CME Group market data. Confirm
  redistribution before a commercial mirror. Settlements
  are the final session print, not a live quote.

### 390. Statnett Nordic production and consumption *(new)*

- **Value:** live Nordic and Baltic generation, consumption,
  and fuel split, with no API key — the physical print Nord
  Pool day-ahead prices (#384) do not carry.
- **Entry point:** `GET https://driftsdata.statnett.no/restapi/ProductionConsumption/GetLatestDetailedOverview`
- **Docs:** https://www.statnett.no/en/for-stakeholders-in-the-power-industry/data-from-the-power-system/
- **Access:** no authentication; JSON, about **22 KB**.
  `MeasuredAt` **2026-09-26T06:45:00Z**. Production MW:
  Norway **16,872**, Sweden **15,873**, Finland **8,164**,
  Denmark **4,628**, Estonia **731**, Lithuania **1,088**,
  Latvia **488**. Consumption: Norway **13,866**, Sweden
  **16,363**, Finland **8,322**, Denmark **4,029**. Norway
  fuel on the same payload (interval labeled **09:30–09:45**
  local, `measuredAt` **2026-09-26T07:30:00Z**): hydro
  **15,494**, wind **1,084**, thermal **220**, not specified
  **74**, nuclear blank. Norway net exchange **−3,006**,
  equal to consumption minus production. Thousands separators
  in the JSON are non-breaking spaces.
- **Implementation:** poll and upsert `(measuredAt,
  countryCode, series)`. Parse the non-breaking space before
  converting to a number. A dash is null, not zero. Sweden,
  Denmark, Finland, and the Baltic rows fold here; start
  with Norway production, consumption, hydro, and wind.
  Negative net exchange stays negative. Nord Pool (#384)
  remains the price sibling.
- **Terms/risk:** Statnett open power-system data. This is
  an operational snapshot, not an archive. Attribute
  Statnett.
...
|---|---|---|
| OMIE Iberian day-ahead TXT | `https://www.omie.es/sites/default/files/dados/AGNO_2026/MES_09/TXT/INT_PBC_EV_H_1_26_09_2026_26_09_2026.TXT` | **Promoted to P0 #385** (delivery 2026-09-26; 96 quarters; Spanish marginal 0.45–251.08 EUR/MWh). |
| EirGrid / SONI dashboard | `https://www.smartgriddashboard.com/DashboardService.svc/data?area=demandactual&region=ALL&datefrom=26-Sep-2026+00:00&dateto=26-Sep-2026+09:20` | **Promoted to P0 #386** (2026-09-26 09:00 demand 4,697 MW; GEN_EXP 3,515; wind 1,837). |
| Hydro-Québec demand | `https://donnees.hydroquebec.com/api/explore/v2.1/catalog/datasets/demande-electricite-quebec/records?limit=1` | **Promoted to P0 #387** (2026-09-26T07:45:00Z demand 14,675 MW; 112 filled of 192). |
| CAMMESA region demand | `https://api.cammesa.com/demanda-svc/demanda/ObtieneDemandaYTemperaturaRegion?id_region=1002` | **Promoted to P0 #388** (2026-09-26 05:05 ART demHoy 12,769 MW). |
| CME settlements `tradeDate` | `https://www.cmegroup.com/CmeWS/mvc/Settlements/Futures/Settlements/425/FUT?tradeDate=09/25/2026` | **Promoted to P0 #389** (2026-09-25 final; WTI NOV 26 settle 92.41; NG and gold fold). |
| Statnett production overview | `https://driftsdata.statnett.no/restapi/ProductionConsumption/GetLatestDetailedOverview` | **Promoted to P0 #390** (2026-09-26T06:45:00Z; Norway production 16,872 MW). |
| Treasury interest expense | `https://api.fiscaldata.treasury.gov/services/api/fiscal_service/v2/accounting/od/interest_expense?sort=-record_date&page[size]=5` | Live (**38** lines on **2026-08-31**). Treasury notes accrued interest **$44,307,873,395.41** for the month / FYTD **$454,797,399,349.12**. Keep P1 beside MTS #374 until an instrument-level debt-service card is scoped. Not the average-interest-rate series (that stays on the terminal Treasury stack). |
| OTE Czech day-ahead chart | `https://www.ote-cr.cz/en/short-term-markets/electricity/day-ahead-market/@@chart-data` | Live chart JSON (price EUR/MWh and volume axes). Keep P1 until a file export is pinned. OMIE (#385) is the cleaner day-ahead file. |
| Monthly Statement of the Public Debt table 1 | `https://api.fiscaldata.treasury.gov/services/api/fiscal_service/v1/debt/mspd/mspd_table_1?sort=-record_date&page[size]=1` | **Promoted to P0 #379** (2026-08-31 total outstanding $40.176tn; table 3 CUSIP detail folds). |
| BPA 5-minute BA load and generation | `https://transmission.bpa.gov/Business/Operations/Wind/baltwg.txt` | **Promoted to P0 #380** (2026-09-25 01:00 PT load 5,928 MW). |
| SPP real-time generation mix | `https://marketplace.spp.org/chart-api/gen-mix/asChart` | **Promoted to P0 #381** (2026-09-25 07:55Z total 30,729.0 MW; wind 15,134.6). |
| AESO current supply demand CSV | `http://ets.aeso.ca/ets_web/ip/Market/Reports/CSDReportServlet?contentType=csv` | **Promoted to P0 #382** (2026-09-25 02:06; AIL 9,185 MW; generation 10,022 MW). |
| USDA AMS boxed-beef cutout `2453` | `https://mpr.datamart.ams.usda.gov/services/v1.1/reports/2453/Current%20Cutout%20Values` | **Promoted to P0 #383** (2026-09-24 Choice 376.12 / Select 352.10). |
| Nord Pool day-ahead SYS price | `https://dataportal-api.nordpoolgroup.com/api/DayAheadPrices?date=2026-09-25&market=DayAhead&deliveryArea=SYS&currency=EUR` | **Promoted to P0 #384** (96 quarter-hours; 87.83–177.28 EUR/MWh). |
| USACE CWMS timeseries catalog | `https://cwms-data.usace.army.mil/cwms-data/catalog/TIMESERIES?office=NWDP&page-size=2` | Catalog live (**30,734** NWDP series) but a named Grand Coulee query returned **0** rows. Keep P1 until an allowlist is pinned. |
...
5. **Commodities, energy, housing, credit:** World Bank Pink Sheet + IMF Primary Commodity Prices +
   ...
   + CME crude / Henry Hub / gold settlements (#389) + USDA AMS boxed-beef cutout (#383).
6. **Power and gas:** Elexon + ENTSOG + MIDAS + Energinet + Elia + REE Spain + RTE éco2mix (#192)
   ...
   + EIA-930 hourly BA balance (#376) + MISO fuel mix (#377) + BPA 5-minute BA (#380)
   + SPP gen mix (#381) + AESO supply (#382) + Nord Pool day-ahead (#384)
   + OMIE Iberian day-ahead (#385) + EirGrid / SONI (#386) + Hydro-Québec demand (#387)
   + CAMMESA region demand (#388) + Statnett Nordic balance (#390)
...
and downloaded the response body on **2026-09-26 UTC** (prior 2026-09-25/24/23/21/20/19/18/17/16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
notes retained where still accurate). FinUties `GET /health` returned `{"status":"online"}` and
`GET /api/v1/status/p0` heartbeat was **green 7/7** (economics probe succeeded in **6.0 ms**; generated **2026-09-26T08:11:39Z**); overall **yellow**
with `content_stale` **2** (economics **355h** vs 168h, ownership **368h** vs 336h). Positioning is inside budget (**104h** vs 192h, COT `report_date` **2026-09-22**). Filings content is **8h** vs 48h (latest **2026-09-26**),
rates **32h** vs 72h (latest **2026-09-25**), and equities **12h** vs 72h (latest **2026-09-25**).

| Source | HTTP | Response type / observation |
|---|---:|---|
| OMIE day-ahead TXT *(new)* | 200 | text; delivery **2026-09-26**; **96** quarters; ES **0.45–251.08** EUR/MWh; first **207.72**; **10,842** bytes; LM **2026-09-25 11:41** |
| EirGrid demand / generation *(new)* | 200 | JSON; updated **26-Sep-2026 09:12:20**; 09:00 demand **4,697 MW** / `GEN_EXP` **3,515** / wind **1,837** / net interchange **1,311** |
| Hydro-Québec demand *(new)* | 200 | JSON; **2026-09-26T07:45:00Z** **14,675 MW**; **112** non-null of **192** |
| CAMMESA region 1002 *(new)* | 200 | JSON; **289** timestamps; **62** with `demHoy`; latest **2026-09-26 05:05 ART** **12,769 MW** |
| CME settlements 425/444/437 *(new)* | 200 | JSON; trade **09/25/2026** final; WTI NOV 26 **92.41** vol **345,783**; HH OCT 26 **3.196**; gold OCT 26 **4287.8** |
| Statnett overview *(new)* | 200 | JSON; **2026-09-26T06:45:00Z**; NO production **16,872 MW** / consumption **13,866** / hydro **15,494** / wind **1,084** |
| FinUties `/health` + `/api/v1/status/p0` *(recheck)* | 200 | `online`; heartbeat **green 7/7**; overall **yellow**; content_stale **2** (economics **355h**, ownership **368h**); positioning **104h** inside 192h; filings **8h** / rates **32h** / equities **12h**; economics probe **6.0 ms**; generated **2026-09-26T08:11:39Z** |
| DTS operating cash *(recheck)* | 200 | JSON; 2026-09-24 close **924,627** million USD; open **947,317**; deposits **278,110**; withdrawals **300,800**; `total-count` **16,642** |
| NY Fed RRP / repo *(recheck)* | 200 | JSON; 2026-09-25 RRP accepted **$576m** at **3.75%** (3 cpty, mature 2026-09-28); morning and afternoon repo accepted **$0** |
| NY Fed securities lending *(recheck)* | 200 | JSON; 2026-09-25 accepted **$42.741bn** par of **$43.460bn**; mature **2026-09-28** |
| NY Fed USD liquidity swaps *(recheck)* | 200 | JSON; still ECB **$197m** and BoE **$10m** at **4.15%**, trade **2026-09-23**, mature **2026-10-01** |
| SOMA as-of *(recheck)* | 200 | JSON; still **2026-09-23** |
| EIA-930 balance Jul–Dec 2026 *(recheck)* | 200 | CSV **22,757,071** bytes; LM **2026-09-25 14:41**; **125,112** data rows; 2026-09-24 h24 PJM demand **80,771 MW**; 2026-09-25 h24 demand blank |
| MISO `/api/FuelMix` *(recheck)* | 200 | JSON; 2026-09-26 03:05 EST total **62,114 MW**; coal **18,474** / gas **18,116** / nuclear **10,043** / wind **13,189** |
| NRC reactor status *(recheck)* | 200 | pipe text; report **2026-09-25**; **95** units / **82** at 100% / **7** at 0 |
| NY Fed SOFR last/1 *(recheck)* | 200 | JSON; effectiveDate **2026-09-24**; **3.88%**; volume **$2,990bn** |
| FRED `DGS10` / `SP500` *(recheck)* | 200 | CSV; DGS10 **2026-09-24** **5.18**; SP500 **2026-09-25** **7743.41** |
| CFTC TFF latest *(recheck)* | 200 | JSON; report_date **2026-09-22**; LM **2026-09-25 19:30** |
| BPA `baltwg.txt` *(recheck)* | 200 | TSV **77,771** bytes; LM **2026-09-26 08:11**; **1,740** filled rows; 2026-09-26 01:10 PT load **5,837 MW** / VER **1,548** / hydro **3,623** |
| SPP gen-mix `asChart` *(recheck)* | 200 | JSON; **2026-09-26T08:05:00Z** total **30,283.1 MW**; wind **18,720.0** / coal **5,300.5** / gas **4,527.3** / storage **−432.0** |
| AESO CSD `contentType=csv` *(recheck)* | 200 | CSV; update **Sep 26, 2026 02:13**; AIL **9,165 MW**; net generation **10,052**; wind TNG **4,108** |
| USDA AMS slug 2453 cutout *(recheck)* | 200 | JSON; **6,470** rows; 2026-09-25 Choice **378.83** / Select **355.76**; published **2026-09-25 14:46:09** |
| Nord Pool day-ahead SYS *(recheck)* | 200 | JSON; delivery **2026-09-26**; **96** quarters; **12.00–135.96** EUR/MWh; first **125.03**; updated **2026-09-26T08:14:11Z** |
| GLEIF lei-records *(recheck)* | 200 | JSON:API; API total **3,443,418**; goldenCopy publish **2026-09-26 00:00:00** (file **3,443,418**) |
| CISA KEV *(recheck)* | 200 | JSON; catalogVersion **2026.09.25**; count **1,726**; CVE-2026-67279, CVE-2026-65660, CVE-2026-87902 added **2026-09-25** |
| FINRA CNMS 20260925 *(recheck)* | 200 | pipe text; LM **2026-09-25 21:18**; 20260926 AccessDenied |
| OCC volume-query 20260925 *(recheck)* | 200 | CSV; `actdate` 09/25/2026; 20260926 body says date cannot exceed 09/25/2026 |
| Coin Metrics BTC PriceUSD `paging_from=end` *(recheck)* | 200 | JSON; **2026-09-25** **84062.16** |
| Fear & Greed `limit=1` *(recheck)* | 200 | JSON; latest value **74** (Greed); timestamp **2026-09-26** |
| OpenSanctions sanctions index *(recheck)* | 200 | JSON; **301,356** entities; updated **2026-09-26T07:47:01** |
...
| FEC `weball26.zip` *(recheck)* | 200 | ZIP; LM **2026-09-26 05:42** |
| Senate LDA filings *(recheck)* | 200 | JSON; **1,977,263** / **56,887** in 2026 |
| OpenFEMA PA funded details *(recheck)* | 200 | JSON; **849,234** |
| OpenFEMA HMA subapplications *(recheck)* | 200 | JSON; **63,564** |
| OpenFEMA plan statuses *(recheck)* | 200 | JSON; **36,726** |
| OpenFEMA HMA FinTx *(recheck)* | 200 | JSON; **142,323** |
| OpenFEMA IA MLP *(recheck)* | 200 | JSON; `$count=true` metadata count **0** — do not replace last good **1,117,726** |
| OpenFEMA Mission Assignments *(recheck)* | 200 | JSON; **43,950** |
| OpenFEMA NFIP claims / policies *(recheck)* | 200 | JSON; **2,725,989** / **74,739,464** |
| OpenFEMA PA Projects Status *(recheck)* | 404 | HTML 404 |
| DOT TOC `d7ji-htf7` *(recheck)* | 200 | JSON; **3,553** |
| ClinicalTrials recruiting / 2026+ *(recheck)* | 200 | JSON; **65,044** / **35,592** |
| BTS freight / border *(recheck)* | 200 | JSON; **26,652** / **276,421** |
| SPC `today.csv` *(recheck)* | 200 | CSV; LM **2026-09-26 08:13** |
| NDBC `latest_obs.txt` *(recheck)* | 200 | text; LM **2026-09-26 08:05** |
| FAA NASSTATUS *(recheck)* | 403 | Access Denied |
| MTS table 1 *(recheck)* | 200 | JSON; statement still **2026-08-31**; `total-count` **3,117** |
| NY Fed PD market share *(recheck)* | 200 | JSON; release still **2026-07-09**, title **QUARTER II 2026** |
| Treasury interest expense *(P1)* | 200 | JSON; record **2026-08-31**; **38** lines; notes accrued month **44,307,873,395.41** |
| OTE day-ahead chart *(P1)* | 200 | JSON chart; price axis EUR/MWh and volume axis |
| Baker Hughes NA page *(recheck)* | timeout | follow-up fetch timed out; weekly XLSX UUID not re-isolated; keep **2026-09-18** |
| MSPD table 1 *(new)* | 200 | JSON; statement **2026-08-31**; total outstanding **40,175,641.13** million USD (**$40.176tn**); public **32,414,988.81**; intragov **7,760,652.32**; marketable **31,828,001.46**; `total-count` **4,659**; oldest **2001-01-31** |
| MSPD table 3 *(fold #379)* | 200 | JSON; same statement; `total-count` **219,321** CUSIP rows |
| BPA `baltwg.txt` *(new)* | 200 | TSV **77,436** bytes; LM **2026-09-25 08:01**; **1,737** filled rows; 2026-09-25 01:00 PT load **5,928 MW** / VER **1,628** / hydro **3,733** |
| SPP gen-mix `asChart` *(new)* | 200 | JSON; **2026-09-25T07:55:00Z** total **30,729.0 MW**; wind **15,134.6** / gas **7,440.4** / coal **6,303.1** / nuclear **1,837.1** / storage **−344.9** |
| AESO CSD `contentType=csv` *(new)* | 200 | CSV; update **Sep 25, 2026 02:06**; AIL **9,185 MW**; net generation **10,022**; interchange **837**; wind TNG **2,262** |
| USDA AMS slug 2453 cutout *(new)* | 200 | JSON; **6,469** rows; 2026-09-24 Choice **376.12** / Select **352.10**; published **2026-09-24 14:49:43** |
| Nord Pool day-ahead SYS *(new)* | 200 | JSON; delivery **2026-09-25**; **96** quarters; **87.83–177.28** EUR/MWh; updated **2026-09-25T08:07:06Z** |
| FinUties `/health` + `/api/v1/status/p0` *(recheck)* | 200 | `online`; heartbeat **green 7/7**; overall **yellow**; content_stale **3** (economics **330h**, ownership **344h**, positioning **248h**); filings **8h** / rates **32h** / equities **12h**; generated **2026-09-25T08:05:10Z** |
| DTS operating cash *(recheck)* | 200 | JSON; 2026-09-23 close **947,317** million USD; open **957,409**; deposits **43,980**; withdrawals **54,071**; `total-count` **16,638** |
| SOMA as-of + summary *(recheck)* | 200 | JSON; as-of **2026-09-23**; Treasury complex **$4,452.30bn**; MBS **$1,902.99bn**; agencies **$2.35bn**; summary rows **1,212** |
| NY Fed RRP / repo *(recheck)* | 200 | JSON; 2026-09-24 RRP accepted **$630m** at **3.75%**; afternoon repo accepted **$1m** at **4.00%**; morning repo accepted **$0** |
| NY Fed securities lending *(recheck)* | 200 | JSON; 2026-09-24 accepted **$37.940bn** par of **$38.575bn** |
| NY Fed USD liquidity swaps *(recheck)* | 200 | JSON; ECB **$197m** and BoE **$10m** at **4.15%**, trade **2026-09-23**, mature **2026-10-01** |
| EIA-930 balance Jul–Dec 2026 *(recheck)* | 200 | CSV **22,495,925** bytes; LM **2026-09-24 14:42**; **123,672** rows / **60** BAs; 2026-09-23 h24 PJM demand **82,161 MW** |
| MISO `/api/FuelMix` *(recheck)* | 200 | JSON; 2026-09-25 03:00 EST total **65,139 MW**; gas **23,219** / coal **21,909** / nuclear **11,933** / wind **2,543** |
| NRC reactor status *(recheck)* | 200 | pipe text; report **2026-09-24**; **95** units / **81** at 100% / **7** at 0 |
| NY Fed SOFR last/1 *(recheck)* | 200 | JSON; effectiveDate **2026-09-23**; **3.87%**; volume **$2,946bn** |
| FRED `DGS10` / `SP500` *(recheck)* | 200 | CSV; DGS10 **2026-09-23** **5.11**; SP500 **2026-09-24** **7704.13** |
| DOL `ar539.csv` *(recheck)* | 200 | CSV; LM **2026-09-24 19:50**; max `rptdate` **2026-09-19** |
| GLEIF lei-records *(recheck)* | 200 | JSON:API; API total **3,441,120**; goldenCopy publish **2026-09-25 00:00:00** (file **3,441,948**) |
| CISA KEV *(recheck)* | 200 | JSON; catalogVersion **2026.09.24**; count **1,723**; CVE-2026-5430 and CVE-2026-71362 added **2026-09-24** |
| FINRA CNMS 20260924 *(recheck)* | 200 | pipe text; LM **2026-09-24 21:18**; 20260925 AccessDenied |
| OCC volume-query 20260924 *(recheck)* | 200 | CSV; `actdate` 09/24/2026; 20260925 body says date cannot exceed 09/24/2026 |
| Coin Metrics BTC PriceUSD `paging_from=end` *(recheck)* | 200 | JSON; **2026-09-24** **84386.58** |
| Fear & Greed `limit=1` *(recheck)* | 200 | JSON; latest value **71** (Greed); timestamp **2026-09-25** |
| OpenSanctions sanctions index *(recheck)* | 200 | JSON; **301,183** entities; updated **2026-09-25T07:47:01** |
| CFTC TFF latest *(recheck)* | 200 | JSON; report_date **2026-09-15**; LM **2026-09-18 19:30** |
| PredictIt `marketdata/all/` *(recheck)* | 200 | JSON; **197** markets |
| SGX `indices/v1.0` *(recheck)* | 200 | JSON; **906** indices |
| UK Sanctions List CSV *(recheck)* | 200 | LM still **2026-09-21 12:51** |
| FEC `weball26.zip` *(recheck)* | 200 | ZIP; LM **2026-09-25 05:46** |
| Senate LDA filings *(recheck)* | 200 | JSON; **1,977,225** / **56,858** in 2026 |
| OpenFEMA PA funded details *(recheck)* | 200 | JSON; **849,212** |
| OpenFEMA HMA subapplications *(recheck)* | 200 | JSON; **63,564** |
| OpenFEMA plan statuses *(recheck)* | 200 | JSON; **36,709** |
| OpenFEMA HMA FinTx *(recheck)* | 200 | JSON; **142,126** |
| OpenFEMA IA MLP *(recheck)* | 200 | JSON; **1,117,726** |
| OpenFEMA Mission Assignments *(recheck)* | 200 | JSON; **43,940** |
| OpenFEMA NFIP claims / policies *(recheck)* | 200 | JSON; **2,725,989** / **74,739,464** |
| OpenFEMA PA Projects Status *(recheck)* | 404 | HTML 404 |
| DOT TOC `d7ji-htf7` *(recheck)* | 200 | JSON; **3,530** |
| ClinicalTrials recruiting / 2026+ *(recheck)* | 200 | JSON; **65,022** / **35,411** |
| BTS freight / border *(recheck)* | 200 | JSON; **26,652** / **276,421** |
| SPC `today.csv` *(recheck)* | 200 | CSV; LM **2026-09-25 08:00** |
| NDBC `latest_obs.txt` *(recheck)* | 200 | text; LM **2026-09-25 07:55** |
| FAA NASSTATUS *(recheck)* | 403 | Access Denied |
| MTS table 1 *(recheck)* | 200 | JSON; statement still **2026-08-31**; `total-count` **3,117** |
| NY Fed PD market share *(recheck)* | 200 | JSON; release still **2026-07-09**, title **QUARTER II 2026** |
| Baker Hughes NA page *(recheck)* | 200 | HTML; current XLSX UUID still `ad65c983-ab99-42c3-9997-0d3118fc72a4` titled **09-18-2026** |
| PJM gen_by_fuel / ISO-NE genfuelmix *(watch)* | 401 | both unauthorized without a key |
| USACE CWMS NWDP catalog *(P1)* | 200 | JSON; **30,734** series; `GCL.Flow-Out` on office NWW returned **0** |
