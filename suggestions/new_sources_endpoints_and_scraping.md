...
**New in this review (2026-09-15):** six newly verified
credential-free official prints. New P0s:
**OpenFEMA NFIP Policies v3**
(`/api/open/v3/NfipPolicies`; **74,739,464** rows;
`asOfDate` **2026-09-08**; the policy book beside
claims #302 — use v3, not deprecated v2
`FimaNfipPolicies`); **CDC Epidemic Trends / Rt**
(`5dqz-y4ea`; **532,475** rows; `as_of` **2026-09-08**;
COVID-19 **240,585** / Influenza **188,169** / RSV
**103,721**); **FRA highway-rail grade-crossing
incidents** (`7wn6-i5b9`; **251,322** rows;
**1,017** in 2026; latest **2026-06-30** CSX
`000232014`); **FRA rail-equipment accidents Form 54**
(`85tf-25kj`; **225,134** rows; **1,019** in 2026;
latest **2026-06-30** NS `171002`); **OpenFEMA Hazard
Mitigation Plan Statuses** (`v1/HazardMitigationPlanStatuses`;
**36,745** jurisdictions; sample RiverCOG 2026 plan
Chester CT awaiting revisions); and **OpenFEMA NFIP
Community Status Book** (`v1/NfipCommunityStatusBook`;
**25,125** communities; Autaugaville AL participating;
`lastRefresh` **2026-08-25**).
**Existing-P0 vintage promotions:** NCUA
`call-report-data-2026-06.zip` now **200** (LM
**2026-09-14 17:34** — was 404); Census QPC
`2026-qtr-table-final-q2.xlsx` now **200** (~65 KB;
LM **2026-09-14 17:00**); EIA `f923_2025.zip` now
**200** (~23.3 MB; LM **2026-09-11 13:28**). Storm
Events directory now lists `c20260910`.
**Existing-P0 updates:** OpenFEMA PA projects
**849,013** (was 848,605); Mission Assignments
**43,838** (was 43,745); HMA subapplications
**63,547** (was 63,415); PA grant-award activities
**1,223,069** (was 1,222,065); NFIP claims v3
**2,725,989** (was 2,724,656); House eFD **1,629**
TSV lines (LM **2026-09-14 13:00**); NSF Sep **70**
/ YTD **6,549**; Senate LDA **1,976,840**; NDBC
**891** stations (LM **2026-09-15 08:15**); NIFC
incidents **500** / perimeters **188**; DOT TOC
**3,337**; CDC WVAL **557,421** (`week_end`
**2026-09-05**); NSSP **657,758**; flu WW
**326,017**; NHSN **21,306** (USA week **2026-09-05**:
3,815 COVID / 1,133 flu / 281 RSV new adm).
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` **green** 8/8 (generated
**2026-09-15T08:19:56Z**); GLEIF **3,430,365** LEIs
(golden copy **2026-09-15T00:00:00Z**); UK Sanctions
List **11-Sep-2026** (LM **2026-09-11 14:02**); CISA
KEV **2026.09.14** (**1,710**); FINRA CNMS **20260914**
live (~546 KB; 20260912 Saturday AccessDenied); OCC
**20260914** CSV live; Fear & Greed **69** Greed;
Coin Metrics BTC **2026-09-14** ~78279; NY Fed SOFR
**2026-09-11** 3.62%; OpenSanctions **293,230**
(updated **2026-09-15**); CFTC TFF/CIT **2026-09-08**;
PredictIt **189** / SGX **904**; FEC `weball26.zip`
LM **2026-09-15 05:46**; DOL ETA 539 through
**2026-09-05** (LM **2026-09-14 19:50**); BTS border
still **275,901**; ClinicalTrials recruiting
**64,669** / 2026+ starts **34,107**; DailyMed
**159,222** (published **2026-09-14 21:51 EST**);
RxNorm **08-Sep-2026**; SPC `today.csv` LM
**2026-09-15 08:20**; FRED `DGS10` **2026-09-11**
4.96 / `SP500` **2026-09-14** 7619.98; NIH RePORTER
FY2026 **64,198**; NCHS `data_as_of` **2026-09-10**.
**Still blocked / watch:** `cbp24*` still 404; FARS
2025 still 404; EIA-860M August / September 2026
still electricity-landing HTML; CDC NWSS COVID
`2ew6-ywp6` still stale (`date_end` **2025-09-07**);
PHMSA `phmsa.dot.gov` still 403; FRA `65fa-qbkf`
keep P1 (narrative PII); NNDSS `x9gk-5huc` keep P1
(**1,974,840**); FDA `ndctext.zip` still fold #168;
OFAC `cons_prim.csv` still extend the US sanctions
adapter; FAA NASSTATUS **403** this run (flaky);
EPA ECHO RCRA / SDWIS unfiltered or slow — keep
beside #318; HMA Mitigated Properties v4 deprecated
**2026-10-15** (fold site inventories #313).
...
and downloaded the response body on **2026-09-15 UTC** (prior 2026-09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
