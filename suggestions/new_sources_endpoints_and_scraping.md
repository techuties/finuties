...
**New in this review (2026-08-25):** five credential-free official prints
that sit outside yesterday's QCEW / IRS EO / Senate LDA / Open Payments
cluster — **USDA FAS PSD Online all-data** (`psd_alldata_csv.zip` ~10.44 MB
→ `psd_alldata.csv` **2,092,688** lines; LM **2026-08-12**; commodity /
country / market-year balances); **EIA electricity plant and utility
survey files** (EIA-860 2024 ZIP ~22.1 MB / 13 members; EIA-860M June 2026
generator XLSX ~13.86 MB, LM **2026-07-23**; EIA-861 2024 ~4.57 MB;
EIA-923 2024 archive ~22.8 MB — July 2026 860M and current `f923_2025.zip`
503/redirect); **CMS Hospital Compare / Provider Data Catalog**
(metastore **236** datasets; hospital general-information CSV **5,419**
facilities / ~1.45 MB; released **2026-08-13**; LM **2026-07-27**);
**CDC NSSP emergency-department visits** (Socrata `rdmq-nq56`;
**648,179** county/HSA rows; `week_end` through **2026-08-15**;
build **2026-08-19**); and **NSF Awards API** (no key; parametric
`dateStart`/`dateEnd`; **6,366** awards in 2026 YTD; **1,976** dated
2026-08-01–08-25; sample award **2617572** Penn State, $494,304,
08/05/2026). **Folds:** Census LODES8 NY WAC 2022 gzip (~2.73 MB; LM
**2024-10-03**) into LEHD QWI #280. **FRED:** `fredgraph.csv` timed out
from this environment (0 bytes / 12–25s) — keep the existing allowlist;
do not add unverified IDs. **Re-verified:** FinUties `/health` online
and `/api/v1/status/p0` **green** 8/8; GLEIF **3,411,119** LEIs (golden
copy **2026-08-25**); UK Sanctions List still **20-Aug-2026** (~49.8 MB;
LM **2026-08-20 11:08**); CISA KEV catalogVersion **2026.08.24**
(1,675); FINRA CNMS **20260824** live (LM **2026-08-24 21:18**;
weekend **20260822** / today **20260825** AccessDenied);
OCC **20260824** CSV live (~5.28 MB; **20260825** rejected as future);
Fear & Greed **74** Greed; Coin Metrics BTC PriceUSD **2026-08-24**
~78894; NY Fed SOFR **2026-08-21** 3.65%; OpenSanctions ~291.5k
(updated **2026-08-25**); CFTC TFF/CIT still **2026-08-18**;
PredictIt **191** markets / SGX **897** / Malaysia CPI / Dallas Fed WEI
(LM still **2026-08-20**) still live; FEC `weball26.zip` refreshed
**2026-08-25 05:39** (~194 KB); DOL ETA 539 LM **2026-08-24 19:50**
(still through **2026-08-15**); BTS border count still **275,901**;
Senate LDA **1,976,339** filings / **56,023** in 2026 (latest
**2026-08-25T00:32:00-04:00**, PORT OF PORTLAND); IRS `eo1.csv` LM
still **2026-08-10**; BLS QCEW US Q4 still ~910 KB. **Still blocked /
watch:** NCUA `call-report-data-2026-06.zip` still 404; `cbp24*` still
404; QPC Q2 2026 still unpublished; OCC derivatives Q2 2026 still 404;
CDC NWSS `2ew6-ywp6` latest `date_end` still **2025-09-07** (stale —
P1); Trade.gov CSL download 404 / `api.trade.gov` TLS expired;
EIA-860M July 2026 and current EIA-923 2025 paths 503; FRED
`fredgraph.csv` timeout this run.
...
| NSF Awards API | `https://api.nsf.gov/services/v1/awards.json?dateStart=...` | **Promoted to P0 #289** (no key; 6,366 awards in 2026 YTD). Requires a parametric filter. |
...
2. **US markets microstructure & banking:** TreasuryDirect auctions + FINRA Reg SHO short volume +
   ...
   NSF Awards (#289) + NCUA Call Report (#244)
...
3. **Financial conditions and macro stats:** Fed H.15 packages (#166) + FRED `fredgraph.csv`
   ...
   EXPGSC1 / TWEXBGSMTH / DEXJPUS / DEXUSUK allowlist companions.
...
5. **Commodities, energy, housing, credit:** World Bank Pink Sheet + IMF Primary Commodity Prices +
   ...
   state WAC) + BLS QCEW
   (#281) + IRS EO BMF (#282) + USDA FAS PSD (#285) + ANBIMA IMA
   (#185) + BCB Focus (#186) + FRED Case-Shiller/UMCSENT/ICSA/
   HOUST/HSN1F/ISRATIO/PERMIT/MORTGAGE30US/CCSA/COMPUTSA/MSPUS allowlist companions.
...
and downloaded the response body on **2026-08-25 UTC** (prior 2026-08-24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
