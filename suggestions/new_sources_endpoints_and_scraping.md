...
**New in this review (2026-09-18):** six newly verified
credential-free official prints. New P0s:
**CDC NREVSS RSV NAAT positivity**
(`3cxc-4k8q`; **40,161**; **3,982** week-end 2026+;
latest **2026-09-12** national **0.4%** / 116
detections — the HHS-region lab print that
dashboard `rgnm-fkqb` and Flu WW #310 do not
carry); **CDC NREVSS COVID-19 NAAT positivity**
(`gvsb-yw6g`; **36,932**; **3,581** in 2026;
latest **2026-09-12** national **4.98%** on
33,128 tests — the COVID companion, not a fold
of the RSV table); **CDC preliminary COVID-19
burden estimates** (`ahrf-yqdt`; **316**; as of
**2026-09-12** illnesses 5.1–14.1M /
hospitalizations 160–270k / deaths 16–46k —
the official weekly nowcast; fold weekly-hosp
`xnjn-rdmd`); **NCHS VSRR quarterly birth
indicators** (`76vv-a7x8`; **1,000**; **100**
in 2026 Q2; general fertility **52.7** per
1,000 — the birth cube overdose #330 does
not carry); **IRS Form 990-N e-Postcard bulk**
(`data-download-epostcard.zip`; **~93.2 MB**
→ **1,545,028** pipe rows through TY **2025**;
LM **2026-09-14** — small-nonprofit filings
next to EO BMF #282); and **CDC emergency-
department respiratory conditions**
(`v58w-vynu`; **11,781**; **2,772** in 2026;
latest week **2026-09-05** infant URI
**11.9%** — condition × age shares, not
pathogen NSSP #288/#333).
**Existing-P0 updates:** OpenFEMA PA funded
details **849,279** (was 849,216); Mission
Assignments **43,857** (was 43,856); HMA
subapplications **63,558** (was 63,553); PA
grant-award activities **1,223,398** (was
1,223,346); Plan statuses **36,746** (was
36,760 — count dropped); IA multiple-loss
flood **1,116,832** (was 1,116,713); HMA
FinTx **139,031** (was 138,957); DOT TOC
**3,393** (was 3,379); GLEIF **3,433,392** /
golden copy **3,434,096**; Senate LDA
**1,977,016**; NSF Sep **100** / YTD
**6,579**; House eFD **1,654** TSV; ClinicalTrials
recruiting **64,806** / 2026+ starts **34,581**;
DailyMed **159,296**; NDBC **844** stations
(was 891); Fear & Greed **56** Greed;
OpenSanctions **300,960**.
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` domains **green** 6/7 +
economics **unknown** (generated
**2026-09-18T08:03:40Z**); overall **yellow**
— positioning `data_age_hours` **248h** vs
the 192h weekly COT budget (`report_date`
still **2026-09-08**); GLEIF golden copy
**2026-09-18T00:00:00**; CISA KEV still
**2026.09.16** (**1,713**); FINRA CNMS
**20260917** live (~545 KB); OCC **20260917**
CSV live; Coin Metrics BTC **2026-09-17**
~76387; NY Fed SOFR **2026-09-16** 3.62%;
CFTC TFF/CIT still **2026-09-08**; UK
Sanctions List still **11-Sep-2026**;
PredictIt **189** / SGX **906**; FEC
`weball26.zip` LM **2026-09-18 05:38**; DOL
`ar539.csv` LM **2026-09-17 19:51**; FRED
`DGS10` **2026-09-16** 5.01 / `SP500`
**2026-09-17** 7637.76; SPC `today.csv` LM
**2026-09-18 08:01**; CDC WVAL still
**557,421** / flu WW **326,017** / NHSN
**21,306** / COVID WW **615,264** / RSV WW
**306,663** / H5 **120,722** / NSSP daily
**301,392** / NSSP weekly **660,951** /
overdose **86,904**; NFIP claims
**2,725,989** / policies **74,739,464**;
FAA NASSTATUS **403** this run (flaky).
**Folds this run:** NHSN preliminary
`mpgq-jmmr` (week ending **2026-09-12**, one
week ahead of official #309 **2026-09-05**)
into #309; COVID weekly-hosp `xnjn-rdmd`
into burden #339; `FemaWebDisasterSummaries`
(4,034) into declarations #87; BTS
waterways/rail/transit/air 319-row cubes
into freight #304.
...
PHMSA `phmsa.dot.gov` still 403; FRA
`65fa-qbkf` keep P1 (narrative PII); NNDSS
`x9gk-5huc` keep P1; FDA `ndctext.zip`
...
8. **Cyber, physical, climate, and country risk:** CISA KEV + FIRST EPSS + OSV.dev + CIRCL CVE +
   ...
   appeals (#335) + NTSB avdata (#336) + IMF PortWatch
...
and downloaded the response body on **2026-09-18 UTC** (prior 2026-09-17/16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
...
(generated **2026-09-18T08:03:40Z**); overall **yellow** because positioning
content age (**248h**, COT `report_date` **2026-09-08**) exceeds the 192h weekly budget.
