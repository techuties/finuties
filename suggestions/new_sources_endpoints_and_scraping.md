...
**New in this review (2026-09-21):** six newly verified
credential-free official prints from the CMS
`data.cms.gov` data-api (no key). New P0s:
**CMS Medicare Monthly Enrollment**
(`d7fabe1e-d19b-4333-9eff-e80e0643f2fd`;
**580,443** rows; **16,685** in 2026;
**3,337** in May 2026 / **3,278**
counties; national May 2026
**70,465,854** enrolled /
**36,068,859** MA; California
**7,227,107** / Alameda County
**278,052** — the Medicare headcount
Medicaid/CHIP #351 does not carry);
**CMS Medicare Quarterly Part D
Spending by Drug**
(`4ff7c618-4e40-483a-b390-c8a58c94fa15`;
**27,748**; **14,773** in 2025 Q1–Q4;
**12,975** in **2026 Q1**; Ozempic
2025 **$16.15B** / **2,044,798**
beneficiaries, 2026 Q1 **$3.96B** /
**1,459,326** — fold the annual
2020–2024 cube); **CMS Medicare
Quarterly Part B Spending by Drug**
(`bf6a5b3b-31ee-4abb-b1ad-2607a1e7510a`;
**1,742**; Keytruda 2025
**$6.36B** / **77,692** beneficiaries
— fold the annual HCPCS cube);
**CMS Medicaid Spending by Drug**
(`be64fce3-e835-4589-b46b-024198e524a6`;
**18,511**; Ozempic 2024 **$3.41B** /
**3,312,575** claims — the national
brand/generic spend cube SDUD #350
does not roll up); **CMS Medicare
Geographic Variation**
(`6219697b-8f6c-4164-bed4-cd9317c58ebc`;
**36,994**; 2024 national
**71,035,683** beneficiaries / MA
**54.84%** / **$377.3B** /
**$13,605.51** per capita; California
**7,247,540** / MA **56.41%** — MA
state table folds here); and **CMS
Medicare Physician & Other
Practitioners by Geography and
Service**
(`6fea9d79-0129-4e4c-b1b8-23cd86a4f435`;
**268,350**; national 99213 facility
**4,505,351** services /
**$175.75** submitted /
**$61.15** allowed).
**Existing-P0 updates:** OpenFEMA PA funded
details **849,304** (was 849,571); HMA
subapplications still **63,562**;
Plan statuses still **36,776**;
IA multiple-loss flood
**1,117,313** (was 1,117,177); HMA FinTx
**141,943** (was 141,896); DOT TOC
**3,444** (was 3,424); GLEIF **3,436,116**
(was 3,435,926); Senate LDA
**1,977,046** / **56,685** in 2026;
OpenSanctions **300,960** (was 300,962);
Coin Metrics BTC **2026-09-20** ~81195
(was 2026-09-19 ~81262). Mission
Assignments catalog **43,878**;
NFIP claims **2,725,989** / policies
**74,739,461**; House eFD **1,665** TSV;
ClinicalTrials recruiting **64,835** /
2026+ starts **34,731**; Fear & Greed
**70** Greed (was 71); CDC WVAL / flu WW /
NHSN / COVID WW / RSV WW / overdose still
the 2026-09-18 prints — NHSN USA week
**2026-09-12** **4,095** COVID /
**1,486** flu / **318** RSV new admits.
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` domains **green** 6/7 +
economics **unknown** (`probe_timeout`;
generated **2026-09-21T08:02:47Z**); overall
**yellow** — filings content **56h** vs 48h
and rates **80h** vs 72h (weekend last
prints **2026-09-19** / **2026-09-18**),
not COT stale (`report_date` **2026-09-15**,
`data_age_hours` **152h** inside the 192h
weekly COT budget); GLEIF golden copy
**2026-09-20T16:00:00Z**; CISA KEV still
**2026.09.18** (**1,716**); FINRA CNMS
**20260918** live (~544 KB);
**20260919**/**20260920** AccessDenied;
OCC **20260918** CSV live (**20260919**
rejected); NY Fed SOFR still
**2026-09-17** 3.85%; CFTC TFF/CIT
**2026-09-15**; UK Sanctions List still
**11-Sep-2026**; PredictIt **190** / SGX
**906**; FEC `weball26.zip` LM
**2026-09-21 05:50**; DOL `ar539.csv` LM
**2026-09-18 19:51**; FRED `DGS10`
**2026-09-17** 4.94 / `SP500`
**2026-09-17** 7637.76; SPC `today.csv`
LM **2026-09-21 08:01**; NDBC LM
**2026-09-21 07:55**; FAA NASSTATUS
still **403** (Monday run).
**Folds this run:** CMS Medicare Part D
annual 2020–2024 cube
(`7e0b4365-…`) into quarterly #356;
CMS Medicare Part B annual HCPCS cube
(`76a714ad-…`) into quarterly #357;
Medicare Advantage Geographic Variation
(`8e989bc0-…`) into geo #359;
CDC BRFSS SMART MMSA `at7e-uhkc`
(**226,116**; **14,632** in 2024) into
BRFSS #348.
**Still blocked / watch:** OpenFEMA
`PublicAssistanceProjectsStatus` (#325)
**404** HTML this run (catalog still
**425,952** / lastRefresh **2026-09-16** —
rediscover before ingest); `cbp24*` still
404; FARS 2025 still 404; EIA-860M August /
September 2026 still electricity landing
HTML; QPC Q3 2026 still 404; NTSB
`up18SEP.zip` 404 (`up15SEP.zip` still the
monthly); CDC NWSS COVID `2ew6-ywp6` still
stale (`date_end` **2025-09-07** — use
`j9g8-acpt` #329); CDC ILINet `6svj-q4zv`
stale (max week **2024-10-05**); RSV burden
`sumd-iwm8` stale (max **2026-06-06**);
weekly adult/child vaccination `5c6r-xi2t`
off-season (max week **2026-05-23**) — keep
P1 until 2026–27 opens; PHMSA
`phmsa.dot.gov` still 403; FRA `65fa-qbkf`
keep P1 (narrative PII); FDA `ndctext.zip`
still fold #168; OFAC `cons_prim.csv` still
extend the US sanctions adapter; EPA ECHO
RCRA / SDWIS unfiltered or slow — keep
beside #318; OpenFEMA firefighter grants
FY2026 is only 21 CUAS awards — keep P1;
EMPG v2 still **24,712** / 2016 close-out
— keep P1; CDC measles WW `akvg-8vrb` and
mpox WW `xpxn-rzgz` fold #329; NHSN
nursing-home RPV `tscn-ryh9` latest week
still **2026-03-29** — keep P1; FAA
NASSTATUS #303 still **403** this Monday
run — retry later in the week; Medicaid
Dual Status monthly and Acute Care
Services max month still **202212** —
keep P1; CDC pollen cubes
(`rq2k-zaqh` / `435k-2whj` / `bgxp-nxmn`)
end **2024** — keep P1 historical.
...
| data.cms.gov data-api catalog | `https://data.cms.gov/data.json` + `/data-api/v1/dataset/{id}/data` | **Hot path curated 2026-09-21:** Monthly Enrollment #355, Part D/B quarterly spend #356/#357, Medicaid spend-by-drug #358, Geographic Variation #359, Physician-by-geography #360. Remaining inpatient/outpatient/SNF/hospice/PDP formulary ZIP stay discovery / same-adapter folds. No API key. |
...
7. **Procurement and public spending:** TED + Find a Tender + SAM.gov + Grants.gov + USAspending
   ...
   Geographic Variation / Physician-by-geography (#355–#360).
...
and downloaded the response body on **2026-09-21 UTC** (prior 2026-09-20/19/18/17/16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
...
(`probe_timeout`; generated **2026-09-21T08:02:47Z**); overall **yellow** because
filings content is **56h** vs 48h and rates **80h** vs 72h after the weekend
(latest prints **2026-09-19** / **2026-09-18**). COT is still inside budget
(`report_date` **2026-09-15**, `data_age_hours` **152h** / 192h).
