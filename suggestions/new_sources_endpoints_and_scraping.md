...
**New in this review (2026-09-17):** six newly verified
credential-free official prints. New P0s:
**CDC Wastewater RSV**
(`45cq-cw4i`; **306,663**; **72,623** collect 2026+;
latest detect **2026-09-08** DuPage IL 12,030 copies/g
sludge — the RSV site-level companion to flu A #310
and COVID #329); **CDC Wastewater Influenza A H5**
(`mtpu-urpp`; **120,722**; **39,738** collect 2026+;
**33** detects since Aug; latest detect **2026-09-03**
Morris NJ 13,560 copies/L — avian-flu WW, not a fold
of seasonal flu A); **CDC NSSP Emergency Department
Respiratory Daily** (`vjzj-u7u8`; **301,392**;
**53,040** in 2026; latest **2026-09-12** NC ARI
9.15% / COVID 0.77% / flu 0.66% / RSV 0.04% — the
daily ED share next to weekly NSSP #288); **OpenFEMA
Declaration Denials** (`v1/DeclarationDenials`;
**1,303**; **22** `requestStatusDate` 2026+; **11**
request-date 2026+; latest Idaho flood turndown
status **2026-09-02** — the refused-request cube
declarations #87 does not carry); **OpenFEMA Public
Assistance Second Appeals Tracker**
(`v1/PublicAssistanceSecondAppealsTracker`;
**1,775**; **193** HQ-received 2026+; sample Union
Township NJ **Denied** decision **2026-01-30** —
the appeals ledger next to PA status/awards); and
**NTSB aviation accident Access dumps** (`avall.zip`
~96.1 MB plus monthly `upDDMMM.zip`; `up15SEP.zip`
~728 KB live — official CAROL extract, no developer
key).
**Existing-P0 updates:** OpenFEMA PA funded details
**849,216** (was 849,178); Mission Assignments
**43,856** (was 43,850); HMA subapplications
**63,553** (was 63,549); PA grant-award activities
**1,223,346** (was 1,223,249); Plan statuses
**36,760** (was 36,754); IA multiple-loss flood
**1,116,713** (was 1,116,540); HMA FinTx now
**138,957** (was 141,525 — count dropped this
refresh); DOT TOC **3,379** (was 3,359); CDC NSSP
weekly **660,951** (was 657,758); VSRR overdose
**86,904** (was 86,265); GLEIF **3,432,184** /
golden copy **3,432,760**; Senate LDA **1,976,973**;
NSF Sep **89** / YTD **6,568**; House eFD **1,649**
TSV; ClinicalTrials recruiting **64,752** / 2026+
starts **34,397**; DailyMed **159,284**; NDBC
**891** stations; Fear & Greed **50** Neutral;
OpenSanctions **300,908**.
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` domains **green** 7/8 +
economics **unknown** (generated
**2026-09-17T08:01:43Z**); overall **yellow** —
positioning `data_age_hours` **224h** vs the 192h
weekly COT budget (`report_date` still
**2026-09-08**, Friday print not yet out);
GLEIF golden copy **2026-09-17T00:00:00Z**; CISA
KEV **2026.09.16** (**1,713**); FINRA CNMS
**20260916** live (~544 KB); OCC **20260916** CSV
live; Coin Metrics BTC **2026-09-16** ~76082;
NY Fed SOFR **2026-09-15** 3.64%; CFTC TFF/CIT
still **2026-09-08**; UK Sanctions List still
**11-Sep-2026**; PredictIt **187** / SGX **906**;
FEC `weball26.zip` LM **2026-09-17 05:44**; DOL
`ar539.csv` LM **2026-09-16 19:51**; FRED `DGS10`
**2026-09-15** 5.00 / `SP500` **2026-09-16**
7551.81; SPC `today.csv` LM **2026-09-17 08:00**;
CDC WVAL still **557,421** / flu WW **326,017** /
NHSN **21,306** / COVID WW **615,264**; NFIP
claims **2,725,989** / policies **74,739,464**;
FAA NASSTATUS **200** this run (was 403).
**Still blocked / watch:** OpenFEMA
`PublicAssistanceProjectsStatus` (#325) **404**
HTML this run (catalog still lists **426,013** /
lastRefresh **2026-09-16** — rediscover before
ingest); `cbp24*` still 404; FARS 2025 still 404;
EIA-860M August / September 2026 still electricity
landing HTML; QPC Q3 2026 still 404; CDC NWSS
COVID `2ew6-ywp6` still stale (`date_end`
**2025-09-07** — use `j9g8-acpt` #329); PHMSA
`phmsa.dot.gov` still 403; FRA `65fa-qbkf` keep
P1 (narrative PII); NNDSS `x9gk-5huc` keep P1;
FDA `ndctext.zip` still fold #168; OFAC
`cons_prim.csv` still extend the US sanctions
adapter; EPA ECHO RCRA / SDWIS unfiltered or slow
— keep beside #318; OpenFEMA firefighter grants
FY2026 is only 21 CUAS awards — keep P1; CDC
measles WW `akvg-8vrb` and mpox WW `xpxn-rzgz`
(**303,261**; **5** detects since Aug) fold #329
until a pathogen-specific product is scoped; NHSN
nursing-home RPV `tscn-ryh9` latest week still
**2026-03-29** — keep P1.
...
and downloaded the response body on **2026-09-17 UTC** (prior 2026-09-16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
notes retained where still accurate). FinUties `GET /health` returned `{"status":"online"}` and
`GET /api/v1/status/p0` domains were **green** 7/8 with economics **unknown**
(generated **2026-09-17T08:01:43Z**); overall **yellow** because positioning
content age (**224h**, COT `report_date` **2026-09-08**) exceeds the 192h weekly budget.
