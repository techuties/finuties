...
**New in this review (2026-09-20):** six newly verified
credential-free official prints. New P0s:
**Medicaid NADAC weekly drug
acquisition costs** (2026 vintage
`fbb83258-11c7-47f5-8b18-5f8e79f7e704`;
**1,118,109** rows; **29,936** as_of
**2026-09-16**; sample 12HR nasal
decongestant ER NDC 24385005452
**$0.28051** / EA effective
**2026-08-19** — the pharmacy
invoice-price print openFDA #168 and
DailyMed #296 do not carry);
**Medicaid State Drug Utilization
Data** (2026 `2957a7f9-9a15-453e-9afd-3bbdcbac8fd3`;
**1,287,884**; **635,323** unsuppressed;
Q1 2026 Alaska TRULICITY **73** Rx /
**$70,562** reimbursed — fold 2023–2025
vintages); **Medicaid and CHIP
applications, eligibility, and
enrollment** (`6165f45b-ca93-5bb5-9d06-db29c692a360`;
**11,016**; **459** in 2026; May 2026
California **11,762,641** enrolled /
**84,561** new agency apps —
renewals fold here); **Medicaid ACA
Federal Upper Limits**
(`ce4cf49b-a21b-5a53-bbc3-509414940847`;
**2,261,691**; **155,922** in 2026;
August 2026 acebutolol 200 mg FUL
**$0.61644**); **Medicaid Drug Rebate
Program product catalog**
(`0ad65fe5-3ad3-5d79-a3f9-7893ded7963a`;
**2,002,508**; **94,901** in 2026 /
**47,538** in 2026 Q2; Lilly ZEPBOUND
NDC 00002015204); and **CDC PLACES
census-tract prevalence** (`cwsq-ngmh`;
**3,047,284**; **2,629,753** in **2023**;
Jefferson AL tract 01073010900 any
disability **44.9%** — the local
model overlay BRFSS #348 does not
carry).
**Existing-P0 updates:** OpenFEMA PA funded
details **849,571** (was 849,314); HMA
subapplications **63,562** (was 63,561);
Plan statuses **36,776** (was 36,760);
IA multiple-loss flood
**1,117,177** (was 1,117,026); HMA FinTx
**141,896** (was 141,816); DOT TOC
**3,424** (was 3,411); GLEIF **3,435,926**
(was 3,434,832); Senate LDA
**1,977,045** / **56,684** in 2026;
OpenSanctions **300,962** (was 300,960);
Coin Metrics BTC **2026-09-19** ~81262
(was 2026-09-18 ~80944). Mission
Assignments still **43,872**; PA
grant-award catalog **1,223,558**;
NFIP claims **2,725,989** / policies
**74,739,464**; NSF Sep **107** / YTD
**6,586**; House eFD **1,666** TSV;
ClinicalTrials recruiting **64,835** /
2026+ starts **34,731**; DailyMed
**159,279**; Fear & Greed still **71**
Greed; CDC WVAL / flu WW / NHSN /
COVID WW / RSV WW / H5 / ED
conditions / NSSP / overdose still
the 2026-09-19 prints (weekend).
**Re-verified:** FinUties `/health` online;
`/api/v1/status/p0` domains **green** 6/7 +
economics **unknown** (`probe_timeout`;
generated **2026-09-20T08:05:09Z**); overall
**yellow** — economics unmeasured, not COT
stale (`report_date` **2026-09-15**,
`data_age_hours` **128h** inside the 192h
weekly COT budget); GLEIF golden copy
**2026-09-19T16:00:00Z**; CISA KEV still
...
**2026-09-20 05:41**; DOL `ar539.csv` LM
**2026-09-18 19:51**; FRED `DGS10`
**2026-09-17** 4.94 / `SP500`
**2026-09-17** 7637.76; SPC `today.csv`
LM **2026-09-20 07:58**; NDBC LM
**2026-09-20 07:50**; FAA NASSTATUS
**403** this run (was 200 yesterday).
**Folds this run:** NADAC Comparison
`a217613c-…` and First Time NADAC
`e3af839d-…` into NADAC #349; SDUD
2023–2025 vintages into #350;
Medicaid/CHIP renewals
`5abea2e0-…` into enrollment #351;
Drug AMP reporting monthly/quarterly
(status R/NR only — no AMP dollars)
into MDRP #353; MDRP labeler /
state contacts into #353; national
respiratory deaths `4bc2-bbpq` still
fold #306.
...
NASSTATUS #303 **403** this Sunday run
(was 200 yesterday) — retry weekdays.
...
| data.medicaid.gov metastore | `https://data.medicaid.gov/api/1/metastore/schemas/dataset/items` | Still **554** datasets (2026-09-20). **Hot path curated:** NADAC #349, SDUD #350, enrollment #351, FUL #352, MDRP #353. Remaining scorecard/ETL-test and weekly MDRP-new-drug files stay discovery-only. |
...
and downloaded the response body on **2026-09-20 UTC** (prior 2026-09-19/18/17/16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
