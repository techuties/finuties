...
| OpenSanctions sanctions collection | `https://data.opensanctions.org/datasets/latest/sanctions/index.json` (+ `targets.simple.csv` ~68 MB; full `entities.ftm.json` ~352 MB) | Index live (~292k entities, updated 2026-08-06). Prefer Canada/UK/US/EU/UN official lists in P0 first; use `targets.simple.csv` only as a secondary cross-check with license review. |
