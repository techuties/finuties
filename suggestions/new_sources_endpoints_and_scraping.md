...
SOMA CUSIP holdings below are a different contract from those series and from H.4.1
factors (#221).
...
**New in this review (2026-09-22):** six newly verified
credential-free official prints. New P0s:
**NY Fed SOMA CUSIP holdings** (as-of
**2026-09-16**; Treasury **434** CUSIPs /
**$4,448.41bn** par; MBS **8,387** lines /
**$1,906.11bn** current face; agency
**8,953** lines / **$2.35bn** par — the
security-level book H.4.1 #221 does not
carry); **CFPB/FFIEC HMDA data browser**
(no key; 2025 conventional
**10,224,134** loans / **$4.402T**;
2025 originated **6,827,891** /
**$2.407T**; California originated
**572,268** / **$344.7bn**);
**Baker Hughes North America rig count**
(week **2026-09-18**; US **595**
(+4 w/w, +53 y/y) oil **452** / gas
**134**; Canada **197**; North America
**792** — the current XLSX UUID is on
the rig-count page); **CMS MSSP
Performance Year financial results**
(`73b2ce14-351d-40ac-90ba-ec9e1f5ba80c`;
**476** ACOs; PY **2024** file revised
**2026-07-17**; earned save/loss
**$4.122bn**; generated **$6.547bn**;
**360** positive / **16** negative;
**10,326,340** assigned beneficiaries);
**CMS Part D prescribers by geography
and drug**
(`c8ea3f8e-3a09-4fea-86f2-8902fb4b0920`;
**117,661**; coverage through
**2024-12-31**; Ozempic national
**$12.97bn** / **1,951,892**
beneficiaries / **10,413,554** claims);
and **CMS nursing-home chain
performance**
(`97ecfad1-d3f1-4d42-b774-d74661d830bc`;
**611** chains; through **2026-08-31**;
national **14,702** facilities / **3.0**
stars / **13,257** fines /
**$456.8M**).
**Existing-P0 updates:** OpenFEMA PA funded
details **849,298** (was 849,304); HMA
subapplications still **63,562**;
Plan statuses still **36,776**;
IA multiple-loss flood
**1,117,415** (was 1,117,313); HMA FinTx
**141,945** (was 141,943); Mission
Assignments **43,890** (was 43,878);
NFIP claims still **2,725,989** / policies
**74,739,464** (was 74,739,461); DOT TOC
**3,467** (was 3,444); GLEIF **3,436,618**
(was 3,436,116); Senate LDA
**1,977,072** / **56,711** in 2026;
OpenSanctions **300,974** (was 300,960);
Coin Metrics BTC **2026-09-21** **86505.30**
(was 2026-09-20 ~81195). House eFD
**1,673** TSV lines; ClinicalTrials
recruiting **64,887** / 2026+ starts
**34,931**; Fear & Greed **78** Extreme
Greed (was 70).
...
**2026-09-22T08:16:26Z**); overall
**yellow** with `content_stale` **0** —
filings content is back inside budget
(**8h** vs 48h, latest **2026-09-22**) and
rates are back inside budget (**32h** vs
72h, latest **2026-09-21**). COT
`report_date` **2026-09-15**,
`data_age_hours` **176h** inside the 192h
weekly budget. GLEIF golden copy publish
**2026-09-22 00:00:00** (file
`record_count` **3,437,327**); CISA KEV
**2026.09.21** (**1,717**; CVE-2026-7273
added **2026-09-21**); FINRA CNMS
**20260921** live (LM **2026-09-21 21:18**);
OCC **20260921** CSV live (`actdate`
09/21/2026); NY Fed SOFR **2026-09-18**
3.85%; UK Sanctions List **21-Sep-2026**
(LM **2026-09-21 12:51**); PredictIt
**192** / SGX **906**; FEC `weball26.zip`
LM **2026-09-22 05:40**; DOL `ar539.csv` LM
**2026-09-21 20:06**; FRED `DGS10`
**2026-09-18** 5.01 / `SP500`
**2026-09-21** 7764.70; SPC `today.csv`
LM **2026-09-22 08:01**; NDBC LM
**2026-09-22 08:05**; FAA NASSTATUS
still **403**.
**Folds this run:** CMS ACO directory
`69ec2609-…` (**511**), participants
`9767cb68-…` (**15,370**), county
beneficiaries `ae8c9418-…` (**135,203**,
year **2024**), and ACO REACH
`6c3532b3-…` (**115**, `PERF_YEAR`
**2024**) into MSSP #364; Part D
prescribers by provider `14d8e8a9-…`
(**1,416,883**) and by provider-and-drug
`9552739e-…` (**28,023,892**) into
geography #365.
...
times out; USDA FAS Open Data ESR returns
**"Bad API Key"** — not zero-credential
(PSD ZIP #285 stays the no-key path);
CMS Program Statistics MA inpatient/SNF
cubes are not on the data-api (raw file
only) — not promoted; prepaid shared
savings `522f7e2d-…` is **29** rows of
N/A dollars — keep P1; CFTC TFF/CIT still
**2026-09-15**; `cbp24*` / FARS 2025 /
QPC Q3 / EIA-860M August still the prior
watch list.
...
and downloaded the response body on **2026-09-22 UTC** (prior 2026-09-21/20/19/18/17/16/15/09-01/08-31/30/27/26/25/24/23/22/21/20/19/18/17/15/14/11/09/08/07/06/05/04/03/02/01/07-31
...
(`probe_timeout` on `im_ecb_observations`; generated **2026-09-22T08:16:26Z**); overall **yellow**
with `content_stale` **0**. Filings content is **8h** vs 48h and rates **32h** vs 72h
(latest **2026-09-22** / **2026-09-21**). COT is still inside budget
(`report_date` **2026-09-15**, `data_age_hours` **176h** / 192h).
