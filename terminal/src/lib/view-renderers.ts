/**
 * View Renderers -- shared view icons and helpers for dashboard cards.
 *
 * Community extension contract:
 * - Add new view keys here first.
 * - Use the same key across card definitions and UI toggles.
 * - Keep icon paths 24x24 stroke-based for visual consistency.
 */
...
export const VIEW_ICONS: Record<string, string> = {
  ...
  map: '<path stroke-linecap="round" stroke-linejoin="round" d="M9 6.75V15m0 0l-3-3m3 3l3-3m-8.25 6a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z"/>',
  table: '<path stroke-linecap="round" stroke-linejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125m-9.75 0V5.625m0 12.75v-12.75A1.125 1.125 0 014.5 4.5h15c.621 0 1.125.504 1.125 1.125v12.75"/>',
